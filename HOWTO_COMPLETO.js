...
TEMPLATE:;
    ...
    class OpenNomeEngine {
        __init__(self) {
            // (sem operacao)
        _demo(self) {
            console.log("Demo roda sem erro");
...
if (__name__ == "__main__") {
    console.log("=" * 80);
    console.log("  HOW-TO COMPLETO DA OPENREPUBLIC");
    console.log("  Do zero ao tudo. 116 sistemas. CC0.");
    console.log("=" * 80);
    console.log(RESUMO);
    console.log(PARTE_1_CIDADAO);
    console.log(PARTE_2_COMUNIDADE);
    console.log(PARTE_3_GOVERNO);
    console.log(PARTE_4_DEV);
    console.log(PARTE_5_LEGO);
    console.log(PARTE_6_MODO);
    console.log(PARTE_7_CHECKLIST);
    console.log(PARTE_8_FAQ);
    console.log(PARTE_9_RECURSOS);
    console.log("\n{'='*80}");
    console.log("  HOW-TO COMPLETO. 9 partes. Comece pela Parte 1 (hoje).");
    console.log("  A República não espera permissão. Começa em você.");
    console.log("=" * 80);
