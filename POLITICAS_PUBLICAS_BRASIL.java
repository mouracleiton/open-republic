...
public class PropostaDePolticasPblicasParaOBrasil {
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  POLÍTICAS PÚBLICAS PARA O BRASIL");
        System.out.println("  Baseadas em 116 sistemas | 91.729 linhas | OpenRepublic");
        System.out.println("=" * 80);
        total = 0;
        /* para cada (area, politicas) em POLITICAS.items(): */
            ...
            /* para cada (pid, p) em politicas.items(): */
                total = total + 1;
                System.out.println("  [{pid}] {p['titulo']}");
                System.out.println("    Problema: {p['problema'][:70]}...");
                System.out.println("    Custo: {p['custo_atual']}");
                System.out.println("    Economia: {p['economia']}");
                System.out.println("    Prazo: {p['prazo']}");
                System.out.println("    Sistema: {p['sistema']}");
        System.out.println("\n\n{'='*80}");
        System.out.println("  TOTAL: {total} políticas públicas em {len(POLITICAS)} áreas");
        System.out.println("  Base: 116 sistemas | 91.729 linhas de código | CC0");
        System.out.println("  Brasil: do capitalismo predatório à República do bem comum");
        System.out.println("  20-25 anos. Gradual. Sem trauma. Com dignidade.");
        System.out.println("{'='*80}");
}
