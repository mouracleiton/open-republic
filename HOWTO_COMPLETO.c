...
#ifndef HOW_TO_COMPLETO_DA_OPENREPUBLIC_H
#define HOW_TO_COMPLETO_DA_OPENREPUBLIC_H
...
TEMPLATE:;
    ...
    // Classes aqui...
    typedef struct OpenNomeEngine {
        void __init__(self) {
            // (sem operacao)
        void _demo(self) {
            printf("Demo roda sem erro");
...
if (__name__ == "__main__") {
    printf("=" * 80);
    printf("  HOW-TO COMPLETO DA OPENREPUBLIC");
    printf("  Do zero ao tudo. 116 sistemas. CC0.");
    printf("=" * 80);
    printf(RESUMO);
    printf(PARTE_1_CIDADAO);
    printf(PARTE_2_COMUNIDADE);
    printf(PARTE_3_GOVERNO);
    printf(PARTE_4_DEV);
    printf(PARTE_5_LEGO);
    printf(PARTE_6_MODO);
    printf(PARTE_7_CHECKLIST);
    printf(PARTE_8_FAQ);
    printf(PARTE_9_RECURSOS);
    printf("\n{'='*80}");
    printf("  HOW-TO COMPLETO. 9 partes. Comece pela Parte 1 (hoje).");
    printf("  A República não espera permissão. Começa em você.");
    printf("=" * 80);

#endif // HOW_TO_COMPLETO_DA_OPENREPUBLIC_H
