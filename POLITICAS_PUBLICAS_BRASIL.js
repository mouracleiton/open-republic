...
if (__name__ == "__main__") {
    console.log("=" * 80);
    console.log("  POLÍTICAS PÚBLICAS PARA O BRASIL");
    console.log("  Baseadas em 116 sistemas | 91.729 linhas | OpenRepublic");
    console.log("=" * 80);
    total = 0;
    para cada (area, politicas) em POLITICAS.items(): {
        ...
        para cada (pid, p) em politicas.items(): {
            total = total + 1;
            console.log("  [{pid}] {p['titulo']}");
            console.log("    Problema: {p['problema'][:70]}...");
            console.log("    Custo: {p['custo_atual']}");
            console.log("    Economia: {p['economia']}");
            console.log("    Prazo: {p['prazo']}");
            console.log("    Sistema: {p['sistema']}");
    console.log("\n\n{'='*80}");
    console.log("  TOTAL: {total} políticas públicas em {len(POLITICAS)} áreas");
    console.log("  Base: 116 sistemas | 91.729 linhas de código | CC0");
    console.log("  Brasil: do capitalismo predatório à República do bem comum");
    console.log("  20-25 anos. Gradual. Sem trauma. Com dignidade.");
    console.log("{'='*80}");
