...
public class OpensymbolrevisionRessignificacaoECorrecaoDePreconceitos {
    ...
    // ============================================================================
    public static class PrejudiceType {
        ...
        LANGUAGE = "idioma";
        BODY = "corpo";
    public static class CorrectionSeverity {
    ...
    // ============================================================================
    // decorador: @dataclass
    public static class PrejudiceCorrection {
        ...
        String educational_context = ""  // contexto historico/cientifico;
        String alternative_phrase = ""  // como falar corretamente;
        String source = ""  // fonte da correcao;
    ...
    // decorador: @dataclass
    public static class SymbolRevision {
        ...
        String democratic_decision = "";
        int people_affected = 0 // quantas pessoas tem o simbolo;
        String ressignification_art = ""  // como transformar visualmente;
    ...
    // ============================================================================
    public static class SymbolRevisionEngine {
        ...
        public {texto: qualquer} fact_check_phrase(self, phrase: texto) {
            ...
            matches = [];
            /* TODO: for-each Java para pc em self.prejudices.values() */
        ...
        public String _action_recommendation(self, severity: CorrectionSeverity) {
            if (severity.value <= 1) {
        ...
        public [Dict] batch_fact_check(self, phrases: [texto]) {
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  OPENSYMBOLREVISION");
        System.out.println("  Correcao de Preconceitos + Ressignificacao de Simbolos");
        System.out.println("=" * 80);
        ...
        /* TODO: for-each Java para phrase em test_phrases */
            result = engine.fact_check_phrase(phrase);
            System.out.println("\n  FRASE: '{phrase}'");
            if (result["identified"]) {
                System.out.println("  TIPO: {result['type']} (severidade: {result['severity']})");
                System.out.println("  POR QUE ERRADO: {result['why_wrong'][:120]}...");
                System.out.println("  CORRECAO: {result['correction'][:120]}...");
                System.out.println("  COMO FALAR: {result['how_to_say'][:100]}...");
                System.out.println("  ACAO: {result['action']}");
            } else {
                System.out.println("  {result['message']}");
        // === 2. DADOS QUE PROVAM ===
        System.out.println("\n\n  === 2. DADOS QUE PROVAM QUE PRECONCEITO E MENTIRA ===\n");
        /* TODO: for-each Java para pc em engine.prejudices.values() */
            System.out.println("\n  [{pc.correction_id}] '{pc.original_phrase[:50]}...'");
            System.out.println("  Tipo: {pc.prejudice_type.value}");
            System.out.println("  Dados:");
            /* TODO: for-each Java para d em pc.data */
                System.out.println("    - {d}");
        // === 3. RESSIGNIFICACAO DE SIMBOLOS ===
        System.out.println("\n\n  === 3. RESSIGNIFICACAO DE SIMBOLOS ===\n");
        // Votar na suastica
        r1 = engine.ressignify_symbol("SYM-001", votes_for=7000, votes_against=3000);
        System.out.println("  {r1['symbol']}: {r1['status']}");
        System.out.println("  {r1['decision'][:100]}");
        System.out.println("  Arte: {r1['art'][:80]}");
        // Votar no numero de faccao
        r2 = engine.ressignify_symbol("SYM-002", votes_for=8000, votes_against=2000);
        System.out.println("\n  {r2['symbol']}: {r2['status']}");
        System.out.println("  Novo significado: {r2['new_meaning'][:80]}");
        System.out.println("  Arte: {r2['art'][:80]}");
        // === 4. DETALHE: HISTORIA DA SUASTICA ===
        System.out.println("\n\n  === 4. SIMBOLO DETALHADO: SUASTICA ===\n");
        sym = engine.symbols["SYM-001"];
        System.out.println("  Nome: {sym.name}");
        System.out.println("  Significado ORIGINAL: {sym.original_meaning[:120]}...");
        System.out.println("  COOPTADO por: {sym.coopted_by} ({sym.coopted_period})");
        System.out.println("  Significado nocivo: {sym.coopted_meaning}");
        System.out.println("  RESSIGNIFICACAO: {sym.new_meaning[:120]}...");
        System.out.println("  Status: {sym.status.value}");
        System.out.println("  Arte de transformacao: {sym.ressignification_art}");
        // === 5. STATS ===
        System.out.println("\n\n  === 5. ESTATISTICAS ===\n");
        s = engine.stats();
        ...
        // === FILOSOFIA ===
        System.out.println("\n\n{'='*80}");
        System.out.println("  FILOSOFIA DO OPENSYMBOLREVISION");
        System.out.println("{'='*80}");
        System.out.println(""";
    ...
    // )
        System.out.println("{'='*80}");
        System.out.println("  OpenSymbolRevision: {s['corrections_made']} correcoes, ";
            "{s['symbols_reclaimed']} simbolos ressignificados.");
        System.out.println("  Frase errada -> Republica corrige.");
        System.out.println("  Simbolo nocivo -> Republica ressignifica.");
        System.out.println("  Pessoa estigmatizada -> Republica acolhe.");
        System.out.println("{'='*80}");
}
