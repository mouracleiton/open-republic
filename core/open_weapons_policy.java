...
public class OpenweaponspolicyPoliticaDePorteDeArmasDaRepublica {
    ...
    public static class WeaponPermit {
    ...
    public static class PermitRequirement {
    ...
    public static class WeaponItem {
        ...
        String description = "";
        String legitimate_use = ""  // uso legitimo (trabalho, defesa);
        ...
        boolean open_carry = false // pode portar visivel?;
        boolean concealed_carry = false // pode portar escondido?;
        boolean home_only = false // so em casa?;
    ...
    // ============================================================================
    public {texto: qualquer} run_weapons_assembly(n_voters: inteiro = 10000) {
    ...
    // 4. MOTOR DE ARMAS
    // ============================================================================
    public static class WeaponsEngine {
    ...
    //
        ...
        funcao request_permit(self, citizen_id: texto, citizen_name: texto,
                        item_id: texto,;
                        String has_martial_arts_belt = "",;
                        boolean psych_eval_passed = false,;
                        boolean has_violent_record = false,;
                        boolean assembly_approval = false,;
                        boolean community_endorsement = false,;
                        boolean safe_storage = false,;
        ...
        public {texto: qualquer} revoke_permit(self, citizen_id: texto, reason: texto) {
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  OPENWEAPONSPOLICY -- PORTE DE ARMAS DA REPUBLICA");
        System.out.println("  OpenMartialArts primeiro. Arma de fogo ultimo recurso.");
        System.out.println("=" * 80);
        // === 1. ASSEMBLEIA ===
        ...
        /* TODO: for-each Java para w em engine.catalog.values() */
            ...
            System.out.println("  {w.name:<30} max:{w.max_per_person:>2} reqs:{req_count} local:{location}");
        // === 3. PEDIDOS DE PORTE ===
        System.out.println("\n\n  === 3. PEDIDOS DE PORTE ===\n");
        ...
        if ("failed_requirements" in r) {
            System.out.println("  Faltam: {', '.join(r['failed_requirements'])}");
        ...
        System.out.println("  {r['message']}");
        if ("conditions" in r) {
            /* TODO: for-each Java para c em r["conditions"] */
        ...
        /* TODO: for-each Java para line em engine.philosophy() */
        ...
        System.out.println("\n{'='*80}");
        System.out.println("  OpenWeaponsPolicy: {s['proibidos']} proibidos, ";
            "{s['armas_fogo_restritas']} restritas. ";
            "{s['portes_ativos']} portes ativos.");
        System.out.println("  {s['politica']}");
        System.out.println("{'='*80}");
}
