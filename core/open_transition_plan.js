...
class Phase {
    ...
    __init__(self, label, timeline, goal) {
        self.label = label;
...
class FinancialProjection {
    ...
    phase: Phase;
    const consulting_revenue = 0 // hibrido;
    const product_revenue = 0 // autofinanciamento (TEIA, etc);
    const cooperative_revenue = 0 // cooperativa;
    const costs = 0;
    const net = 0;
    calculate(self) {
