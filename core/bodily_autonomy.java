...
public class OpenrepublicEmendaConstitucionalAutonomiaCorporal {
    ...
    public static class BodilyRight {
    ...
    // decorador: @dataclass
    public static class ConstitutionalRight {
    ...
    // ============================================================================
    public static class HistoricalViolation {
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  EMENDA CONSTITUCIONAL: AUTONOMIA CORPORAL");
        System.out.println("  'O corpo && a fronteira ultima da liberdade.'");
        System.out.println("=" * 80);
        // === 1. The Amendment ===
        System.out.println(""";
    PRINCIPIO CONSTITUCIONAL NUMERO 2:;
    ...
    // )
        ...
        /* TODO: for-each Java para r em RIGHTS */
            System.out.println("\n  {'='*70}");
            System.out.println("  DIREITO: {r.right.value.upper()}");
        ...
        /* TODO: for-each Java para v em HistoricalViolation.VIOLATIONS */
            System.out.println("\n  {v['perpetrator']} ({v['country']}, {v['era']})");
            System.out.println("    Vitimas: {v['victims']}");
            System.out.println("    Violacao: {v['violation']}");
            System.out.println("    Licao: {v['lesson']}");
        // === Philosophy ===
        System.out.println("\n\n{'='*80}");
        System.out.println("  POR QUE ISSO É CONSTITUCIONAL");
        System.out.println("{'='*80}");
        System.out.println(""";
