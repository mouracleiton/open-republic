...
#ifndef OPENCOFOUNDERREPARATION_REPARACAO_HISTORICA_DO_CO_EM_COFUNDADOR_H
#define OPENCOFOUNDERREPARATION_REPARACAO_HISTORICA_DO_CO_EM_COFUNDADOR_H
...
// ============================================================================
typedef struct CofounderReparation {
    // O 'CO' e reparacao, nao hierarquia.
    char* principio = "CO = dois fundadores iguais, ! um principal + adjunto";
    // Os DOIS cofundadores sao METADES IGUAIS da fundacao
    char* fundador_um = "Cleiton Moura Loura";
    char* fundador_dois = "MING";
    double participacao_um = 0.5;
    double participacao_dois = 0.5;
    bool verificar_igualdade(self) {
    ...
    char* interpretar_co(self, prefixo: texto) {
        ...
        if (prefixo == "cofundadora") {
            ...
            return prefixo;
    bool e_subalternizacao(self, termo: texto) {
        ...
        /* TODO: iterador C manual para padrao em padroes_proibidos */
...
typedef struct AuditoriaCofundacao {
    ...
    bool reparacao_ativa = true;
    [texto] violacoes = [];
    [texto] auditar(self, cofundador_a: Dict, cofundador_b: Dict) {
        [texto] problemas = [];
        ...
        return problemas;
    char* relatorio(self) {
        if (sizeof(self.violacoes) == 0) {
            return "REPARACAO CO: OK. Dois cofundadores iguais confirmados.";
        } else {
            return "REPARACAO CO: " + texto(sizeof(self.violacoes)) + " violacoes detectadas";
// ============================================================================
// 4. DECLARACAO CONSTITUCIONAL DO CO
// ============================================================================
typedef struct DeclaracaoCO {
...
// ============================================================================
typedef struct TwoPersonRuleCO {
    ...
    bool validar_pr(self, autor_id: texto, revisor_id: texto) {
...
#endif // OPENCOFOUNDERREPARATION_REPARACAO_HISTORICA_DO_CO_EM_COFUNDADOR_H
