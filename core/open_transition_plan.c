...
#ifndef OPENTRANSITIONPLAN_PLANO_DE_EXECUCAO_DAS_4_DECISOES_DA_ASSEMBLEIA_H
#define OPENTRANSITIONPLAN_PLANO_DE_EXECUCAO_DAS_4_DECISOES_DA_ASSEMBLEIA_H
...
typedef struct Phase {
    ...
    void __init__(self, label, timeline, goal) {
        self.label = label;
...
typedef struct Action {
    ...
    double cost_brl = 0;
    double revenue_potential_brl = 0;
    [texto] dependencies = field(default_factory=list);
    bool done = false;
// decorador: @dataclass
typedef struct FinancialProjection {
    // Projecao financeira por fase.
    phase: Phase;
    double consulting_revenue = 0 // hibrido;
    double product_revenue = 0 // autofinanciamento (TEIA, etc);
    double cooperative_revenue = 0 // cooperativa;
    double costs = 0;
    double net = 0;
    void calculate(self) {
...
// ============================================================================
[FinancialProjection] financial_projections(void) {
    ...
    /* TODO: iterador C manual para p em projections */
        p.calculate();
    return projections;
// ============================================================================
// 5. RELATORIO
// ============================================================================
char* print_plan(void) {
    lines = [];
    lines.append("=" * 110);
...
#endif // OPENTRANSITIONPLAN_PLANO_DE_EXECUCAO_DAS_4_DECISOES_DA_ASSEMBLEIA_H
