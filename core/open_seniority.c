...
#ifndef OPENSENIORITY_NIVEIS_DE_SENIORIDADE_POR_IMPACTO_NAO_HIERARQUIA_H
#define OPENSENIORITY_NIVEIS_DE_SENIORIDADE_POR_IMPACTO_NAO_HIERARQUIA_H
...
// ============================================================================
// decorador: @dataclass
typedef struct PromotionCriteria {
...
// 3. TABELA DE NIVEIS
// ============================================================================
char* print_seniority_table(void) {
...
// ============================================================================
// decorador: @dataclass
typedef struct CompensationCalc {
    ...
    // decorador: @property
    double hours_per_year(self) {
        return self.hours_per_week * self.weeks_per_year;
    // decorador: @property
    double hours_per_month(self) {
...
// ============================================================================
char* map_to_labor_tier(level: SeniorityLevel) {
...
// ============================================================================
void anti_elitism_check(level: SeniorityLevel, stated_by_self: logico = False) retorna (logico, texto) {
...
if (__name__ == "__main__") {
    printf(print_seniority_table());
    printf();
    // Demo: compensacao em cada nivel
    printf();
    printf("DEMO -- Compensacao por nivel (20h/semana, Base 1.0):");
    printf("-" * 70);
    /* TODO: iterador C manual para level em SeniorityLevel */
    ...
    printf();
    printf("DEMO -- Compensacao N6 em carga cheia (40h/semana):");
    printf("-" * 70);
    calc_n6 = CompensationCalc(level=SeniorityLevel.N6, hours_per_week=40.0);
    printf(calc_n6.summary());
    printf();
    printf("DEMO -- Anti-elitismo:");
    printf("-" * 70);
    /* TODO: iterador C manual para level em SeniorityLevel */
        desempacote approved, msg = anti_elitism_check(level, stated_by_self=true);
        status = approved ? "OK" : "BLOQUEADO";
        printf("  N{level.name[1]} autodeclarado: [{status}] {msg}");

#endif // OPENSENIORITY_NIVEIS_DE_SENIORIDADE_POR_IMPACTO_NAO_HIERARQUIA_H
