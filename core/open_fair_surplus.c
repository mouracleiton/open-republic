...
#ifndef OPENFAIRSURPLUS_5_QUE_VOLTA_PRA_QUEM_TRABALHA_H
#define OPENFAIRSURPLUS_5_QUE_VOLTA_PRA_QUEM_TRABALHA_H
...
// ============================================================================
// decorador: @dataclass
typedef struct FairSurplusCalc {
    ...
    // decorador: @property
    double worker_total_month(self) {
...
// ============================================================================
typedef struct FairSurplusEngine {
    ...
    funcao scale_demonstration(self, output_per_worker: flutuante = 4000.0
        ...
        results = [];
        /* TODO: iterador C manual para n em scales */
    ...
    {texto: qualquer} stats(self) {
        return {;
            ...
            "calculos_feitos": sizeof(self.calcs),;
...
if (__name__ == "__main__") {
    ...
    printf("=" * 80);
    printf("  OPENFAIRSURPLUS -- 5% QUE VOLTA PRA QUEM TRABALHA");
    printf("  Mais gente trabalhando = mais se sustentando");
    printf("=" * 80);
    // === 1. A DESCOBERTA ===
    printf(""";
A DESCOBERTA:;
...
// )
    ...
    printf("  Producao por trabalhador: {scale['output_por_trabalhador']}");
    printf("  Surplus: {scale['surplus_pct']}\n");
    printf("  {'Trabalhadores':>15} {'Producao Total':>20} {'5% Circulando':>20} {'Por Trabalhador':>20}");
    printf("  {'-'*80}");
    /* TODO: iterador C manual para r em scale["escala"] */
        printf("  {r['trabalhadores']:>15} {r['producao_total']:>20} ";
    ...
    printf("\n  {r1['message']}");
    printf("  Trabalhador total: {r1['trabalhador_recebe_total']}");
    printf("  No capitalismo, dono levaria: {r1['COMPARACAO_PREDATORIA']['capitalismo_dono_leva']}");
    // FabLab
    r2 = engine.calculate("FabLab Central", "construcao",;
                        workers = 20, output_per_worker_month=6000,;
                        worker_pay_month = 3500);
    printf("\n  {r2['message']}");
    printf("  100 trabalhadores: {r2['ESCALA']['100_trabalhadores']}");
    // Software
    ...
    /* TODO: iterador C manual para f em flow */
        printf("  {f['destino']:<25} {f['pct']:<15} {f['descricao']}");
    // === 5. COMPARACAO CAPITALISMO vs REPUBLICA ===
    printf("\n\n  === 5. CAPITALISMO vs REPUBLICA ===\n");
    comp = engine.compare_capitalism_vs_republic(4000.0);
    printf("  Producao: {comp['producao_por_trabalhador']}\n");
    printf("  CAPITALISMO:");
    ...
    /* para cada (k, v) em s.items(): */
        printf("  {k:<25} {v}");
    printf("\n{'='*80}");
    printf("  OpenFairSurplus: {s['surplus_definido']} que volta. {s['principio']}");
    printf("{'='*80}");

#endif // OPENFAIRSURPLUS_5_QUE_VOLTA_PRA_QUEM_TRABALHA_H
