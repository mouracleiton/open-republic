...
#ifndef TEIA_ESTRUTURA_JURIDICA_COOPERATIVA_VS_EPP_VS_HIBRIDO_H
#define TEIA_ESTRUTURA_JURIDICA_COOPERATIVA_VS_EPP_VS_HIBRIDO_H
...
// ============================================================================
// decorador: @dataclass
typedef struct StructureComparison {
    // Comparacao ponto a ponto.
    criterio: texto;
    cooperativa: texto;
    epp_ltda: texto;
    hibrido: texto;
[StructureComparison] COMPARACAO = [;
    StructureComparison(;
...
char* print_report(void) {
    ...
    lines.append("-" * 115);
    lines.append("");
    /* TODO: iterador C manual para c em COMPARACAO */
...
#endif // TEIA_ESTRUTURA_JURIDICA_COOPERATIVA_VS_EPP_VS_HIBRIDO_H
