...
package teia_portfolio_de_produtos_de_inteligencia_estrategica
...
type DataProduct struct {
    ...
    margin_pct := 90 // margem (trabalho intelectual tem custo baixo) // float64
// OS 10 FORMATOS
