...
**Arquivo original:** `core/open_transition_plan.py`
...
classe Phase herda de Enum:
    ...
    funcao __init__(self, label, timeline, goal):
        self.label = label
...
classe Action:
    ...
    title: texto
    description: texto
    seja owner: texto = "cleiton"
    seja deadline_days: inteiro = 30
    seja cost_brl: flutuante = 0
    seja revenue_potential_brl: flutuante = 0
    seja dependencies: [texto] = field(default_factory=list)
    seja done: logico = falso


// decorador: @dataclass
classe FinancialProjection:
    // Projecao financeira por fase.
    phase: Phase
    seja consulting_revenue: flutuante = 0 // hibrido
    seja product_revenue: flutuante = 0 // autofinanciamento (TEIA, etc)
    seja cooperative_revenue: flutuante = 0 // cooperativa
    seja costs: flutuante = 0
    seja net: flutuante = 0

    funcao calculate(self):
...
seja PLAN: [Action] = [
    ...
    Action(
        ...
        decision = "hibrido",
        title = "Mapear contatos FAANG e converter para consultoria",
        description = (
    ...
    Action(
        ...
        description = (
            ...
            "Isso garante pipeline se FAANG nao quiser part-time."
        ),
        deadline_days = 7,
        cost_brl = 0,
    ...
    Action(
        ...
        description = (
            ...
            "Empacotar como: 'Plataforma de Analise Politica para Governos e ONGs.' "
    ...
    Action(
        ...
        description = (
            ...
            "OpenRepublic e CC0 mas pode receber doacoes. "
    ...
    Action(
        ...
        description = (
            ...
            "(c) aceita participar (CONSENTIMENTO, nao imposicao) "
    ...
    Action(
        ...
        description = (
            ...
            "Adaptar a realidade local (nao impor modelo pronto). "
            "Treinar lider local como operador (transferir, nao centralizar). "
            "Meta: 50 familias usando em 3 meses. "
            "Medir: transacoes/mes, inadimplencia (<3%), satisfacao."
        ),
        deadline_days = 150,
        cost_brl = 10000, // infra + treinamento
        revenue_potential_brl = 0, // nao e lucro, e impacto
        dependencies = ["A104"],
    ),
    Action(
        action_id = "A204",
...
funcao financial_projections() -> [FinancialProjection]:
...
funcao print_plan() -> texto:
    ...
    lines.append("    |> receita recursiva nao-vinculada a horas")
    ...
    lines.append("  A consultoria e PONTE, nao destino.")
    lines.append("  O piloto e PROVA, nao experimento.")
    lines.append("")
