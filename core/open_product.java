...
public class OpenproductProdutosOtimizadosParaMeioAmbientePessoasEAnimais {
    ...
    // ============================================================================
    // decorador: @dataclass
    public static class RepublicProduct {
        ...
        String materials_detail = "";
        // Ciclo de vida
        boolean biodegradable = false;
        boolean recyclable = true;
        boolean repairable = true // OpenRepair;
        boolean modular = true // LEGO;
        double lifespan_years = 10.0;
        // Energia
        boolean energy_efficient = true;
        String energy_source = "solar/eolica";
        // Producao
        boolean fablab_producible = true // FabLab fabrica?;
        boolean tested_on_animals = false // PROIBIDO;
        boolean fair_labor = true // trabalho base 1.0;
        // Status
        ProductStatus status = ProductStatus.APPROVED;
        String replacement_for = ""  // substitui qual produto nocivo?;
        String alternative_if_prohibited = "";
        // decorador: @property
        public int overall_score(self) {
    ...
    // 4. MOTOR DE PRODUTOS
    // ============================================================================
    public static class ProductEngine {
        ...
        public {texto: qualquer} evaluate(self, product_id: texto) {
        ...
        public [Dict] list_approved(self) {
            return [;
        ...
        public [Dict] list_prohibited(self) {
            return [;
                {"id": p.product_id, "name": p.name,;
        ...
        public {texto: qualquer} waste_report(self) {
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  OPENPRODUCT -- PRODUTOS QUE NAO PREJUDICAM");
        System.out.println("  Pessoas. Animais. Meio Ambiente. Tudo protegido.");
        System.out.println("=" * 80);
        // === 1. AVALIAR TODOS OS PRODUTOS ===
        System.out.println("\n\n  === 1. AVALIACAO DE PRODUTOS ===\n");
        /* TODO: for-each Java para pid em engine.products */
            r = engine.evaluate(pid);
        // === 2. PRODUTOS APROVADOS ===
        System.out.println("\n\n  === 2. PRODUTOS APROVADOS ===\n");
        approved = engine.list_approved();
        System.out.println("  {'Produto':<25} {'Score':>5} {'Vida':>5} {'Bio':>4} {'Rep':>4} {'Mod':>4} {'Substitui'}");
        System.out.println("  {'-'*85}");
        /* TODO: for-each Java para p em approved */
            System.out.println("  {p['name'][:24]:<25} {p['score']:>5} {p['lifespan']:>4.0f}a ";
        ...
        /* TODO: for-each Java para p em prohibited */
            System.out.println("  {p['name']:<30} DANO: {p['why']}");
            System.out.println("    Alternativa: {p['alternative']}");
        ...
        /* para cada (key, data) em waste.items(): */
            if (key != "message"  &&  isinstance(data, dict)) {
                System.out.println("\n  {key.upper()}:");
                System.out.println("    Atual: {data['atual']}");
                System.out.println("    Republica: {data['republica']}");
        System.out.println("\n  {waste['message']}");
        // === 5. STATS ===
        System.out.println("\n\n  === 5. ESTATISTICAS ===\n");
        s = engine.stats();
        ...
        System.out.println("\n{'='*80}");
        System.out.println("  OpenProduct: {s['aprovados']} aprovados, {s['proibidos']} proibidos. ";
            "Score medio: {s['score_medio_aprovados']}.");
        System.out.println("  Nao prejudica pessoas. Nao prejudica animais. Nao prejudica planeta.");
        System.out.println("{'='*80}");
}
