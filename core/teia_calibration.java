...
public class TeiaParameterCalibrationComoEstabelecerOsParametrosObjetivamente {
    ...
    // ============================================================================
    // decorador: @dataclass
    public static class ReplicationCost {
        ...
        // decorador: @property
        public double total_cost_brl(self) {
            return self.total_hours * self.senior_rate_brl;
        // decorador: @property
        public double floor_price_per_call(self) {
    ...
    // ============================================================================
    // decorador: @dataclass
    public static class MarketComparable {
    ...
    // ============================================================================
    // decorador: @dataclass
    public static class MarketFeedback {
    ...
    public static class DynamicPricer {
    ...
    // ============================================================================
    // decorador: @dataclass
    public static class CalibratedPrice {
        ...
        String feedback_reason = "SEM DADOS AINDA";
        // Camada 4: governance
        flutuante? assembly_override = null;
        String assembly_reason = "";
        // decorador: @property
        public double calibrated_token_cost(self) {
        ...
        // decorador: @property
        public double calibrated_price_brl(self) {
            return self.calibrated_token_cost * 0.10;
    public [CalibratedPrice] calibrate_all() {
    ...
    // 5. RELATORIO
    // ============================================================================
    public String print_calibration() {
        lines = [];
        lines.append("=" * 120);
        ...
        lines.append("-" * 120);
        /* TODO: for-each Java para mc em MARKET_COMPARABLES */
            lines.append(;
                "{mc.provider:<25} ";
                "{mc.product_type:<30} ";
                "R${mc.price_brl:>9,.0f}  ";
        ...
        lines.append("-" * 120);
        /* TODO: for-each Java para c em ordene(calibrated, key=(x) -> x.calibrated_token_cost, reverse=True) */
        ...
        /* para cada (pname, methods) em params: */
            lines.append("  {pname}");
            /* TODO: for-each Java para m em methods */
                lines.append("    -> {m}");
            lines.append("");
        // === REGRA DE OURO ===
        lines.append("-" * 120);
    ...
    if (__name__ == "__main__") {
        System.out.println(print_calibration());
}
