...
public class OpencofounderreparationReparacaoHistoricaDoCoEmCofundador {
    ...
    // ============================================================================
    public static class CofounderReparation {
        // O 'CO' e reparacao, nao hierarquia.
        String principio = "CO = dois fundadores iguais, ! um principal + adjunto";
        // Os DOIS cofundadores sao METADES IGUAIS da fundacao
        String fundador_um = "Cleiton Moura Loura";
        String fundador_dois = "MING";
        double participacao_um = 0.5;
        double participacao_dois = 0.5;
        public boolean verificar_igualdade(self) {
        ...
        public String interpretar_co(self, prefixo: texto) {
            ...
            if (prefixo == "cofundadora") {
                ...
                return prefixo;
        public boolean e_subalternizacao(self, termo: texto) {
            ...
            /* TODO: for-each Java para padrao em padroes_proibidos */
    ...
    // ============================================================================
    public static class ErroReparacao extends Erro {
        // Lancado quando o principio CO e violado.
        // seja mensagem: texto
    // ============================================================================
    // 3. AUDITORIA DE GENERO NA FUNDACAO
    // ============================================================================
    public static class AuditoriaCofundacao {
        ...
        boolean reparacao_ativa = true;
        [texto] violacoes = [];
        public [texto] auditar(self, cofundador_a: Dict, cofundador_b: Dict) {
            [texto] problemas = [];
    ...
    // ============================================================================
    public static class DeclaracaoCO {
        ...
        public String ler(self) {
            return self.declaracao;
        public [texto] assinaturas(self) {
    ...
    // ============================================================================
    public static class TwoPersonRuleCO {
        ...
        public boolean validar_pr(self, autor_id: texto, revisor_id: texto) {
