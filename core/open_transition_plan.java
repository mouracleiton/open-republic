...
public class OpentransitionplanPlanoDeExecucaoDas4DecisoesDaAssembleia {
    ...
    public static class Phase {
        ...
        public void __init__(self, label, timeline, goal) {
            self.label = label;
    ...
    // ============================================================================
    public [FinancialProjection] financial_projections() {
        ...
        /* TODO: for-each Java para p em projections */
            p.calculate();
        return projections;
    // ============================================================================
    // 5. RELATORIO
    // ============================================================================
    public String print_plan() {
        lines = [];
        lines.append("=" * 110);
