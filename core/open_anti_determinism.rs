...
struct DeterministicNarrative {
    ...
    let real_example: String = ""  // exemplo real de mudanca;
// As 12 narrativas
let NARRATIVES: [DeterministicNarrative] = [;
...
struct AntiDeterminismEngine {
    ...
    fn fact_check_determinism(self, phrase: texto) -> {texto: qualquer} {
    ...
    fn get_narrative(self, determinism_type: DeterminismType) -> {texto: qualquer} {
...
if __name__ == "__main__" {
    ...
    println!("=" * 80);
    println!("  OPENANTIDETERMINISM -- O FUTURO NAO ESTA ESCRITO");
    println!("  O passado && contexto. O futuro && escolha.");
    println!("=" * 80);
    // === 1. AS 12 MENTIRAS DETERMINISTAS ===
    println!("\n\n  === 12 NARRATIVAS DETERMINISTAS DERRUBADAS ===\n");
    for n in NARRATIVES {
        println!("\n  [{n.narrative_id}] {n.determinism_type.value.upper()}");
        println!("  A MENTIRA: {n.the_lie[:70]}...");
        println!("  A VERDADE: {n.the_truth[:70]}...");
        println!("  CIENCIA: {n.scientific_evidence[:70]}...");
        println!("  SISTEMA: {n.republic_system}");
        println!("  EXEMPLO: {n.real_example[:70]}...");
    ...
    for phrase in test_phrases {
        ...
        if result["identified"] {
            println!("  Tipo: {result['determinism_type']}");
            println!("  Verdade: {result['the_truth'][:70]}...");
    // === 3. STATS ===
    println!("\n\n  === ESTATISTICAS ===\n");
    s = engine.stats();
    ...
    // === FILOSOFIA ===
    println!("\n\n{'='*80}");
    println!("  FILOSOFIA: ANTI-DETERMINISMO");
    println!("{'='*80}");
    println!(""";
...
PRINCIPIOS:;
    ...
    let P3: Dar condicoes para mudar = trabalho de impacto maximo.;
    P4: Assembleia garante: futuro aberto para todos.;
// )
    println!("{'='*80}");
    println!("  OpenAntiDeterminism: {s['narrativas_derrubadas']} narrativas derrubadas.");
    println!("  {s['principio']}");
    println!("{'='*80}");
