...
#ifndef OPENREPUBLIC_EMENDA_CONSTITUCIONAL_AUTONOMIA_CORPORAL_H
#define OPENREPUBLIC_EMENDA_CONSTITUCIONAL_AUTONOMIA_CORPORAL_H
...
// decorador: @dataclass
typedef struct ConstitutionalRight {
...
// ============================================================================
typedef struct HistoricalViolation {
...
if (__name__ == "__main__") {
    printf("=" * 80);
    printf("  EMENDA CONSTITUCIONAL: AUTONOMIA CORPORAL");
    printf("  'O corpo && a fronteira ultima da liberdade.'");
    printf("=" * 80);
    // === 1. The Amendment ===
    printf(""";
PRINCIPIO CONSTITUCIONAL NUMERO 2:;
...
// )
    ...
    /* TODO: iterador C manual para r em RIGHTS */
        printf("\n  {'='*70}");
        printf("  DIREITO: {r.right.value.upper()}");
        printf("  {'='*70}");
        printf("\n  O QUE SIGNIFICA:\n  {r.what_it_means}");
    ...
    /* TODO: iterador C manual para v em HistoricalViolation.VIOLATIONS */
        printf("\n  {v['perpetrator']} ({v['country']}, {v['era']})");
        printf("    Vitimas: {v['victims']}");
        printf("    Violacao: {v['violation']}");
        printf("    Licao: {v['lesson']}");
    // === Philosophy ===
    printf("\n\n{'='*80}");
    printf("  POR QUE ISSO É CONSTITUCIONAL");
    printf("{'='*80}");
    printf(""";
...
#endif // OPENREPUBLIC_EMENDA_CONSTITUCIONAL_AUTONOMIA_CORPORAL_H
