...
public class OpendescriminalizeDescriminalizacaoPopularViaAssembleia {
    ...
    // ============================================================================
    public static class SubstanceCategory {
        ...
        ALCOHOL = "alcool";
        TOBACCO = "tabaco";
    public static class DecriminalizationStatus {
    ...
    public static class PolicyApproach {
    ...
    public static class Substance {
        ...
        String description = "";
        // Politica
        DecriminalizationStatus status = DecriminalizationStatus.DECRIMINALIZED;
        [PolicyApproach] approach = field(default_factory=list);
        // Danos (0-10, base cientifica)
        int physical_harm = 0;
        int addiction_potential = 0;
        int social_harm = 0;
        int therapeutic_potential = 0 // potencial medicinal;
        // Regras
        int min_age = 18;
        boolean public_use = false // pode usar em publico?;
        boolean driving_after = false // pode dirigir apos uso?;
        boolean production_allowed = false // pode cultivar/produzir?;
        boolean commerce_allowed = false // pode vender?;
        // Razao da politica
        String rationale = "";
    ...
    // ============================================================================
    public {texto: qualquer} run_decrim_assembly(n_voters: inteiro = 10000) {
        ...
        substance_votes = {};
        /* TODO: for-each Java para sub em SUBSTANCES */
    ...
    // ============================================================================
    public static class DecrimEngine {
        ...
        funcao check_arrest_type(self, arrest_reason: texto,
                            double quantity_grams = 0,;
                            boolean is_trafficking = false) -> {texto: qualquer}:;
        ...
        public {texto: qualquer} prison_impact_report(self) {
        ...
        public {texto: qualquer} substance_policy(self, substance_id: texto) {
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  OPENDESCRIMINALIZE -- ASSEMBLEIA CONSTITUINTE");
        System.out.println("  'Usuario && PACIENTE. Nao criminoso. Nunca mais.'");
        System.out.println("=" * 80);
        ...
        System.out.println("\n  PACIENTE (tratamento):    {result['votes_patient']:>6} ";
            "({result['pct_patient']})");
        System.out.println("  REGULAR (taxar):          {result['votes_regulate']:>6} ";
            "({result['votes_regulate']/100:.0f}%)");
        System.out.println("  CRIMINOSO (prisao):       {result['votes_criminal']:>6} ";
        ...
        /* para cada (sid, vote) em result["substance_votes"].items(): */
            ...
            System.out.println("  [{icon}] {vote['name']:<25} {vote['yes']:>5} sim / ";
                "{vote['no']:>5} ! ({vote['pct']})");
            System.out.println("       Status: {vote['status']}");
        // === 3. DECISAO DA ASSEMBLEIA ===
        System.out.println("\n\n  === 3. DECISAO DA ASSEMBLEIA ===\n");
        /* para cada (key, val) em result["decision"].items(): */
            status = val ? "SIM" : "NAO";
            System.out.println("  {key:<40} {status}");
        // === 4. POLITICA POR SUBSTANCIA ===
        System.out.println("\n\n  === 4. POLITICA DETALHADA POR SUBSTANCIA ===\n");
        /* TODO: for-each Java para sid em engine.substances */
            policy = engine.substance_policy(sid);
            System.out.println("\n  {policy['substance'].upper()} ({policy['category']})");
            System.out.println("  Status: {policy['status']}");
            System.out.println("  Danos: fisico {policy['harms']['physical']}, ";
                "adicao {policy['harms']['addiction']}, ";
                "social {policy['harms']['social']}, ";
                "terapeutico {policy['harms']['therapeutic']}");
            System.out.println("  Regras: idade {policy['rules']['min_age']}, ";
                "publico: {policy['rules']['public_use']}, ";
                "producao: {policy['rules']['production']}");
            System.out.println("  Razao: {policy['rationale'][:100]}...");
        ...
        /* para reason, qty, trafficking in cases: */
            ...
            action = check["action"];
            System.out.println("  [{check['type']:<11}] {reason:<45} -> {action}");
        ...
        /* para cada (person, sub_id) em treatments: */
            ...
            System.out.println("  {t['person']:<12} {t['substance']:<20} -> {t['treatment_type']}");
            System.out.println("    Voluntario: {t['voluntary']}. P2: {t['p2']}");
        // === 7. IMPACTO PRISIONAL ===
        ...
        // === FILOSOFIA ===
        System.out.println("\n\n{'='*80}");
        System.out.println("  FILOSOFIA DO OPENDESCRIMINALIZE");
        System.out.println("{'='*80}");
        System.out.println(""";
    ...
    PRINCIPIOS:;
        ...
        Tratar adicao P3 = trabalho de alto impacto (medicos, terapeutas).;
        P4: Assembleia DECIDE. 72% votou tratamento. Republica obedece.;
    // )
        System.out.println("{'='*80}");
        System.out.println("  OpenDescriminalize: {s['presos_liberados']} presos liberados, ";
