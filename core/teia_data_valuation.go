...
package teia_datavaluation_nem_todo_dado_vale_o_mesmo
...
type DataValueScore struct {
    ...
    func tier(self) string {
        ...
        if s >= 8.0 {
            ...
            return "COMMODITY"
    // decorador: @property
    func suggested_token_cost(self) float64 {
