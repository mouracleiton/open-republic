...
==========================================================
O TEIA not vende "dossies". Vende INTELIGENCIA.
O dossie and so UM formato. Existem 10.
Cada formato tem publico, preco, and tempo de entrega diferente.
...
class DataProduct:
    ...
    margin_pct: float = 90 // margem (trabalho intelectual tem custo baixo)
# OS 10 FORMATOS
PRODUCTS: [DataProduct] = [
    ...
    DataProduct(
        ...
        description = (
            ...
            "Dados publicos, valor esta na CURACORIA and VISUALIZACAO."
        ),
    ...
    DataProduct(
        ...
        description = (
            ...
            "Desenvolvedores and jornalistas consomem via API. "
    ...
    DataProduct(
        ...
        description = (
            ...
            "'Qual o custo de not fazer saneamento no meu municipio?' "
            "Resposta em 24-48h com dados, fontes, and recomendacao."
        ),
    ...
    DataProduct(
        ...
        description = (
            "Treinamento para equipes de governo or ONG: "
        ...
        recurring = False,
        what_you_already_have = (
            "Voce and professor (@professorcinza). "
    ...
    DataProduct(
        ...
        description = (
            "Dataset limpo, cruzado and documentado: "
            ...
            "Valor esta na LIMPEZA, CRUZAMENTO and DOCUMENTACAO. "
            "Pesquisador/jornalista paga para not perder 3 meses limpando."
        ),
        ...
        recurring = False,
        what_you_already_have = (
            "Dados ja coletados and processados nos 16 dossies. "
            "Capacidade N6 de pipeline de dados. "
            "So empacotar and vender."
        ),
    ...
    DataProduct(
        ...
        description = (
            ...
            "VOCE JA TEM: simulador.html and calculadora5.html."
        ),
    ...
    DataProduct(
        ...
        description = (
            "Para empresas and investidores: "
            ...
            "Fundos de investimento and empresas pagam MUITO por isso."
        ),
...
def print_portfolio() -> str:
    ...
    for p in PRODUCTS:
        ...
        lines.append("  Recorrente:  {'SIM (receita previsivel)' if p.recurring else 'not (one-shot)'}")
    ...
    for p in PRODUCTS:
        if "Zero" in p.effort_to_create  or  "zero" in p.effort_to_create:
            lines.append("    [{p.product_id}] {p.name:<42} R${p.price_range_brl[0]:,}+")
    lines.append("")
    lines.append("  RECEITA EM DIAS (1-7 dias para productizar):")
    for p in PRODUCTS:
        if "1 semana" in p.effort_to_create  or  "dias" in p.effort_to_create.lower():
            lines.append("    [{p.product_id}] {p.name:<42} R${p.price_range_brl[0]:,}+")
    lines.append("")
    ...
    lines.append("-" * 120)
    lines.append("")
    lines.append("  Para not depender de venda unica, montar portfolio com:")
    lines.append("")
    recurring = [p para p em PRODUCTS if p.recurring]
    oneshot = [p para p em PRODUCTS if not p.recurring]
