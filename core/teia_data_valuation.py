...
class DataValueScore:
    ...
    def score(self) -> float:
        ...
        return sum(values[k] * self.WEIGHTS[k] para k em self.WEIGHTS)
    # decorador: @property
    def tier(self) -> str:
        ...
        if s >= 8.0:
            ...
            return "COMMODITY"
    # decorador: @property
    def suggested_token_cost(self) -> float:
...
DATASETS: [ValuatedDataset] = [
    ...
    ValuatedDataset(
        ...
        why_valuable = (
            "Exclusivo. TEIA and a UNICA fonte no Brasil com 35 politicas "
    ...
    ValuatedDataset(
        ...
        score = DataValueScore(
            scarcity = 6, // VIGISAN and publico, mas cruzamento not
            demand = 10, // TODO MUNDO precisa saber fome
            freshness = 5, // censo de 2022, atualiza em 5 anos
            exclusivity = 7, // dado bruto publico, cruzamento and exclusivo
        ...
        why_valuable = (
            "Alto impacto + alta demanda. Dado bruto (VIGISAN) and publico, "
            "mas o CRUZAMENTO por municipio com CADunico, saneamento and "
            "educacao so TEIA fez. Jornalista/prefeito not consegue sozinho."
        ),
        why_not_more = "Dado bruto and publico. Qualquer um pode baixar VIGISAN.",
    ),
    ValuatedDataset(
    ...
    ValuatedDataset(
        ...
        description = "Perfil de negativados por regiao and renda",
        source = "SPC/Boa Vista/Peic 2024",
        score = DataValueScore(
            scarcity = 7, // SPC not and gratis, precisa pagar
        ...
        why_not_more = "Dado base ja and comercializado por SPC/Serasa.",
    ),
    ValuatedDataset(
        ...
        why_valuable = (
            ...
            "Mas SNIS and publico. Valor do TEIA: cruza com impacto sanitario."
        ),
        why_not_more = "SNIS and publico. So o cruzamento and exclusivo.",
    ),
    # ======================================================================
    # BRONZE (score 3.5-5)
    # ======================================================================
    ValuatedDataset(
        ...
        score = DataValueScore(
            scarcity = 3, // CAGED and totalmente publico and facil
            demand = 7, // jornalistas and economistas
            freshness = 8, // mensal
            exclusivity = 2, // todo mundo tem CAGED
            decision_impact = 5, // informativo mas not habilita decisao direta
            connection = 6,
            risk_prevention = 3,
        ),
        current_token_cost = 0.5,
        why_valuable = (
            "Demanda alta mas zero exclusividade. CAGED and publico, facil de baixar. "
            "TEIA so adiciona conveniencia (not precisa baixar/limpar)."
        ),
    ...
    ValuatedDataset(
        ...
        current_token_cost = 0.5,
        why_valuable = "INEP and publico and facil. Valor do TEIA and so conveniencia.",
    ...
    ValuatedDataset(
        ...
        source = "DATASUS",
        score = DataValueScore(
            scarcity = 2, // DATASUS and publico
            demand = 5,
        ...
        current_token_cost = 0.8,
        why_valuable = "Conveniencia. Dado bruto and publico and facil.",
...
def print_valuation() -> str:
    ...
    lines.append("-" * 115)
    for each (name, weight) in DataValueScore.WEIGHTS.items():
        desc = {
            ...
            "exclusivity": "So TEIA tem? Modelo de impacto = sim. IBGE = not.",
    ...
    lines.append("")
    # Ordena por score
    ranked = sorted(DATASETS, key=(d) -> d.score.score, reverse=True)
    ...
    lines.append("    Impacto fiscal de 35 politicas -> so TEIA tem -> valor max")
    lines.append("")
    lines.append("  A FORMULA:")
    lines.append("    valor = exclusividade x impacto_da_decisao")
    lines.append("")
    lines.append("    IBGE puro (todo mundo tem, not habilita decisao) = R$0,05")
