...
struct ImpactMetrics {
    ...
    let evidence: String = ""  // justificativa;
    // decorador: @property
    fn vte(self) -> f64 {
...
let IMPACT_DATA: {LaborRole: ImpactMetrics} = {;
...
struct ImpactProfile {
    ...
    let roles: [ImpactRoleAssignment] = field(default_factory=list);
    ...
    fn _fmt_vte(v: flutuante) -> String {
        if v >= 1_000_000 {
...
if __name__ == "__main__" {
    ...
    println!(impact_optimization_report(all_roles, max_hours=50.0));
