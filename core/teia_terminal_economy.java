...
public class TeiaTerminalEconomySimulacaoCompleta {
    ...
    funcao simulate_demand(
        ...
        results = [];
        /* TODO: for-each Java para profile em ResellerProfile */
    ...
    // ============================================================================
    public static class PoolDistribution {
    ...
    public static class ModuleAccess {
        ...
        boolean sensitive = false // se true, NINGUEM fora da equipe TEIA acessa;
        boolean teia_only = false // se true, so TEIA direto (! revendedor);
        String description = "";
    ...
    funcao check_access(reseller_id: texto, cert: Certification, module_id: texto,
                    boolean is_teia_direct = false) -> {texto: qualquer}:;
    ...
    // ============================================================================
    // decorador: @dataclass
    public static class CryptoPaymentAnalysis {
        ...
        //
        boolean viable = true;
        String stablecoin_recommended = "USDC";
        String reason = (;
    ...
    // ============================================================================
    public String print_simulation() {
        lines = [];
        lines.append("=" * 115);
        ...
        /* TODO: for-each Java para cert em Certification */
        ...
        lines.append("  " + "-" * 105);
        /* TODO: for-each Java para s em splits */
            lines.append(;
                "  {s['item']:<25} ";
        ...
        lines.append("  " + "-" * 95);
        /* TODO: for-each Java para p em pool_splits */
            lines.append(;
                "  {p['area']:<25} ";
                "{p['pct']*100:>5.0f}%  ";
                "R${p['amount_brl']:>9,.0f}  ";
        ...
        lines.append("  " + "-" * 75);
        /* TODO: for-each Java para m em MODULES */
        ...
        /* TODO: for-each Java para r em analysis.requirements */
            lines.append("    -> {r}");
        lines.append("");
        lines.append("  BENEFICIOS:");
        /* TODO: for-each Java para b em analysis.benefits */
            lines.append("    + {b}");
        lines.append("");
        lines.append("  RISCOS:");
        /* TODO: for-each Java para r em analysis.risks */
            lines.append("    ! {r}");
        lines.append("");
        // === 8. PROJECAO ANUAL ===
        lines.append("-" * 115);
