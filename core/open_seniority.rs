...
struct PromotionCriteria {
    ...
    let requirements: [texto] = field(default_factory=list);
    let evidence_required: [texto] = field(default_factory=list);
    let review_by: String = "";
let PROMOTION_CRITERIA: {SeniorityLevel: PromotionCriteria} = {;
...
// 3. TABELA DE NIVEIS
// ============================================================================
fn print_seniority_table() -> String {
...
// decorador: @dataclass
#[derive(Debug, Clone)]
struct CompensationCalc {
    // Calcula compensacao por nivel, horas, e modo (Ideal vs Executavel).
    level: SeniorityLevel;
    let hours_per_week: f64 = 20.0 // Base 1.0 = 20h/semana;
    let weeks_per_year: i64 = 46;
    // decorador: @property
    fn hours_per_year(self) -> f64 {
        return self.hours_per_week * self.weeks_per_year;
    // decorador: @property
    fn hours_per_month(self) -> f64 {
...
// ============================================================================
fn map_to_labor_tier(level: SeniorityLevel) -> String {
...
// ============================================================================
fn anti_elitism_check(level: SeniorityLevel, stated_by_self: logico = False) retorna (logico, texto) {
...
if __name__ == "__main__" {
    println!(print_seniority_table());
    println!();
    // Demo: compensacao em cada nivel
    println!();
    println!("DEMO -- Compensacao por nivel (20h/semana, Base 1.0):");
    println!("-" * 70);
    for level in SeniorityLevel {
