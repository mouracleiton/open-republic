...
public class OpencreatorOContratoIndividualColetivo {
    ...
    // decorador: @dataclass
    public static class LaborObligation {
    ...
    // ============================================================================
    public static class CreatorParadox {
    ...
    // ============================================================================
    public static class ContributionMetric {
    ...
    public static class IndividualContribution {
        ...
        // decorador: @property
        public String recognition_level(self) {
        ...
        // decorador: @property
        public int authority_level(self) {
    ...
    // ============================================================================
    public static class CreatorContract {
        ...
        public {texto: qualquer} evaluate_individual(self, contrib: IndividualContribution) {
        ...
        public String _verdict(self, c: IndividualContribution) {
            if (c.excess) {
                return (;
            ...
            return "INCOMPLETO.";
        public String _recommendation(self, c: IndividualContribution) {
            if (c.excess) {
                return (;
        ...
        funcao the_founder_question(self, name: texto, systems: inteiro,
            ...
            return answer;
        public String _direct_answer(self, ratio: flutuante, systems: inteiro) {
            if (ratio < 1) {
                return (;
        ...
        public [texto] _creator_bill_of_rights(self) {
    ...
    public static class DependencyCheck {
        ...
        //
        // decorador: @dataclass
        public static class DependencyMetric {
            citizen_id: texto;
            name: texto;
            ...
            // decorador: @property
            public double dependency_score(self) {
            ...
            // decorador: @property
            public boolean is_critical(self) {
                return self.dependency_score >= 50;
        public {texto: qualquer} assess(self, metric: DependencyMetric) {
            return {;
                "citizen": metric.name,;
        ...
        public String _action(self, m: DependencyMetric) {
            if (m.is_critical) {
                return (;
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  OPENCREATOR -- O CONTRATO INDIVIDUAL-COLETIVO");
        System.out.println('  "Quanto de mim pertence ao coletivo?"');
        System.out.println("=" * 80);
        // === 1. O CONTRATO BASE ===
        System.out.println("\n\n  === 1. O CONTRATO BASE 1.0 ===\n");
        System.out.println("  {contract.obligation.contract}");
        // === 2. PARADOXO DO CRIADOR ===
        System.out.println("\n\n  === 2. O PARADOXO DO CRIADOR ===\n");
        /* TODO: for-each Java para p em CreatorParadox */
            System.out.println("  [{p.value[0].upper()}]");
            System.out.println("  {p.value[1]}");
            System.out.println();
        // === 3. A PERGUNTA DO FUNDADOR ===
        System.out.println("\n\n  === 3. A PERGUNTA DO FUNDADOR ===\n");
        System.out.println('  "Quanto de mim (Cleiton) tem que se dar pelo coletivo?"');
        System.out.println();
        ...
        System.out.println("    Horas totais dadas:     {c['horas_totais_dadas']:.0f}h");
        System.out.println("    Razao vs contrato base: {c['ratio_vs_base']}");
        System.out.println("    Sistemas criados:       {c['sistemas_criados']}");
        System.out.println("    Linhas escritas:        {c['linhas_escritas']:,}");
        System.out.println("    Pessoas impactadas:     {c['pessoas_impactadas']:,}");
        av = result['avaliacao'];
        System.out.println("\n  RECONHECIMENTO: {av['recognition_level']}");
        System.out.println("  AUTORIDADE:     {av['authority_level']} voto (igual a todos)");
        System.out.println("  EXCESSO:        {'SIM -- Republica deve intervir' if av['excess_detected'] else 'Nao detectado'}");
        ...
        /* TODO: for-each Java para right em result['declaracao_de_direitos_do_criador'] */
        ...
        System.out.println("  Cidadao:           {dep_result['citizen']}");
        System.out.println("  Sistemas solo:     {dep_result['systems_solo_knowledge']}");
        System.out.println("  Documentados:      {dep_result['systems_documented']}");
        System.out.println("  Com sucessor:      {dep_result['systems_with_successors']}");
        System.out.println("  Bus factor:        {dep_result['bus_factor']}");
        System.out.println("  Score dependencia: {dep_result['dependency_score']}");
        System.out.println("  Critico:           {'SIM' if dep_result['critical'] else 'NAO'}");
        ...
        System.out.println("  Bus factor:        {ideal_result['bus_factor']}");
        System.out.println("  Score dependencia: {ideal_result['dependency_score']}");
        System.out.println("  Status:            SAUDAVEL");
        ...
        System.out.println("  {'Nome':<28} {'Ratio':>6} {'Reconhecimento':<16} ";
            "{'Poder':>6} {'Cumprido'}");
        System.out.println("  {'-'*75}");
        /* TODO: for-each Java para ex em examples */
            ev = contract.evaluate_individual(ex);
            System.out.println("  {ex.name:<28} {ev['contribution_ratio']:>6} ";
    ...
    // )
        System.out.println("{'='*80}");
        System.out.println("  OpenCreator: O contrato entre o EU && o NOS.");
        System.out.println("  Base: 920h/ano. Max: 1840h/ano. Limite: 2300h/ano.");
        System.out.println("  Poder: SEMPRE 1 voto. Reconhecimento: proporcional.");
        System.out.println("  Anti-elitismo = ninguem && insubstituivel.");
        System.out.println("{'='*80}");
}
