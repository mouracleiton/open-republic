...
public class OpenmentalhygienePoliticaAntiDisseminacaoDeConhecimentoNocivoEmSaudeMental {
    ...
    // ============================================================================
    public static class HarmfulNarrative {
    ...
    public static class TargetVulnerability {
    ...
    // ============================================================================
    // decorador: @dataclass
    public static class MentalHealthContent {
        ...
        boolean has_monetization = false // curso, livro, clinic, produto;
        ...
        // Decisao
        String action = ""  // permitido, aviso, correcao, bloqueado;
        String counter_narrative = ""  // o que dizer no lugar;
        String corrected_info = ""  // informacao correta;
    // ============================================================================
    ...
    // ============================================================================
    public static class MentalHygieneEngine {
        ...
        funcao analyze_content(self, author: texto, content_text: texto,
                            String platform = "OpenSocialNetwork",;
                            String title = "",;
                            TargetVulnerability target = TargetVulnerability.ADULT_GENERAL,;
                            boolean has_monetization = false,;
        ...
        funcao _calculate_harm(self, detected: [HarmfulNarrative],
            ...
            if (monetization) {
                base = minimo(base + 1, 5);
            if (tamanho(detected) >= 3) {
                base = minimo(base + 1, 5);
            return HarmLevel(base);
        public int _narrative_weight(self, n: HarmfulNarrative) {
            weights = {
        ...
        funcao _decide_action(self, detected: [HarmfulNarrative],
            ...
            return "permitido", "";
        public String _corrected_info(self, detected: [HarmfulNarrative]) {
            if (! detected) {
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  OPENMENTALHYGIENE -- PROTECAO CONTRA NARRATIVAS NOCIVAS");
        System.out.println("  Caso Felca: anti-disseminacao de adoecimento psicologico perpetuo");
        System.out.println("=" * 80);
        // === 1. TIPOS DE NARRATIVA NOCIVA ===
        System.out.println("\n\n  === 1. NARRATIVAS NOCIVAS DETECTAVEIS ===\n");
        /* TODO: for-each Java para n em HarmfulNarrative */
            counter = COUNTER_NARRATIVES.get(n, "");
            System.out.println("  [{n.value}]");
            System.out.println("    Correcao: {counter[:80]}...");
        ...
        /* TODO: for-each Java para tc em test_contents */
            ...
            System.out.println("\n  [{icon}] @{result['author']}");
            System.out.println("  Dano: {result['harm_level']} | Publico: {result['target_audience']}");
            System.out.println("  Detectado: {', '.join(result['detected'])}");
            if (result["counter_narrative"]) {
                System.out.println("  Contra-narrativa: {result['counter_narrative'][:80]}...");
    ...
    // )
        ...
        // === FILOSOFIA ===
        System.out.println("\n\n{'='*80}");
        System.out.println("  FILOSOFIA DO OPENMENTALHYGIENE");
        System.out.println("{'='*80}");
        System.out.println(""";
    CASO FELCA:;
    ...
    // )
        System.out.println("{'='*80}");
        System.out.println("  OpenMentalHygiene: {s['blocked']} bloqueados, ";
            "{s['corrected']} corrigidos, ";
            "{s['warned']} avisados.");
        System.out.println("  Sofrimento ! && identidade. Recuperacao && possivel.");
        System.out.println("  Quem monetiza sua dor NAO quer que voce melhore.");
        System.out.println("{'='*80}");
}
