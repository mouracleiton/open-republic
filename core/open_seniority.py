...
# !/usr/bin/env python3
# 
OpenSeniority -- Niveis de Senioridade por IMPACTO (not hierarquia)
====================================================================
"Na Republica, not existe chefe. Existe IMPACTO.
Quem salva uma vida tem mais impacto que quem escreve uma linha.
Mas quem escreve a linha CERTA pode salvar mil vidas.
O nivel mede o ALCANCE do seu trabalho, not o seu valor como pessoa."
O TETO and PROVADO:
...
Esse and o CHAO do nivel max, not o teto teorico.
A FILOSOFIA:
...
3. not and HIERARQUIA -- N6 not manda em N0. N6 tem mais ALCANCE.
...
EQUIVALENTE MERCADO (referencia, not hierarquia):
...
class SeniorityLevel(Enum):
    ...
    not SAO HIERARQUIA. Sao FAIXAS DE ALCANCE.
    N6 not and "superior" a N0 -- tem mais alcance de impacto.
    ...
    N0 = ("Aprendiz", 0.5, 50.0,
        ...
        "Impacto: PESSOAL (si mesmo and tarefas atribuidas)")
...
class PromotionCriteria:
    ...
    Nao and tempo de casa. Nao and quem voce conhece.
    and: o que voce FEZ que ENABLE outros?
    # 
    level: SeniorityLevel
    requirements: [texto] = field(default_factory=list)
    evidence_required: [texto] = field(default_factory=list)
    review_by: str = ""
PROMOTION_CRITERIA: {SeniorityLevel: PromotionCriteria} = {
    ...
    SeniorityLevel.N2: PromotionCriteria(
        ...
        requirements = [
            ...
            "Projeta solucoes (not so executa)",
    ...
    SeniorityLevel.N3: PromotionCriteria(
        ...
        requirements = [
            ...
            "Resolve problemas que N2 not conseguiu",
        ],
        evidence_required = [
    ...
    SeniorityLevel.N5: PromotionCriteria(
        ...
        requirements = [
            ...
            "Resolver problemas que N4 not consegue",
    ...
    SeniorityLevel.N6: PromotionCriteria(
        ...
        evidence_required = [
            ...
            "Aprovacao por Assembleia Constituinte (democratico, not autodeclarado)",
        ],
...
def print_seniority_table() -> str:
    ...
    lines.append("      O nivel mede ALCANCE, not VALOR humano.")
    lines.append("=" * 100)
    return "\n".join(lines)
# ============================================================================
...
class CompensationCalc:
    ...
    level: SeniorityLevel
    hours_per_week: float = 20.0 // Base 1.0 = 20h/semana
...
# ============================================================================
def map_to_labor_tier(level: SeniorityLevel) -> str:
...
# ============================================================================
def anti_elitism_check(level: SeniorityLevel, stated_by_self: logico = False) retorna (logico, texto):
    ...
    if level in (SeniorityLevel.N4, SeniorityLevel.N5):
        if stated_by_self:
            return False, (
                ...
                "Requer peer review por N5+ (N4) or N6 + Assembleia (N5). "
...
if __name__ == "__main__":
    print(print_seniority_table())
    print()
    # Demo: compensacao em cada nivel
    print()
    print("DEMO -- Compensacao por nivel (20h/semana, Base 1.0):")
    print("-" * 70)
    for level in SeniorityLevel:
