...
public class OpenmultilaboroptimizerV2OtimizacaoComRetornosDecrescentes {
    ...
    valor_hora Formula = taxa * sinergia * foco * CURVA(horas);
    ...
    // ============================================================================
    public double productivity_curve(hours: flutuante) {
    ...
    public String productivity_label(hours: flutuante) {
        if (hours <= 20) {
            return "PEAK";
        } else if (hours <= 35) {
            return "FADIGA";
    ...
    public static class MultiLaborProfileV2 {
        ...
        public double role_effective_rate(self, idx: inteiro) {
    ...
    funcao optimize_v2(
        ...
        results = [];
        n = tamanho(all_roles);
        /* TODO: for-each Java para k em intervalo(min_roles, n + 1) */
            /* TODO: for-each Java para combo em itertools.combinations(intervalo(n), k) */
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println(optimization_report_v2(all_roles, max_hours=50.0));
}
