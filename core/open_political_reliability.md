...
classe ConfiabilidadeEngine:
    ...
    def _gerar_recomendacoes(
        ...
        se TipoIndicador.MIGALHA_DIGITAL in tipos_ativos entao:
        ...
        se TipoIndicador.MISERIA_DEPENDENCIA in tipos_ativos entao:
        ...
        se TipoIndicador.PERSECUICAO_JUDICIAL in tipos_ativos entao:
...
// )
    ...
    // Collor
    declare indicadores_collor: List[IndicadorPolitico]  <- [
        IndicadorPolitico(
            tipo <- TipoIndicador.CORRUPCAO_SISTEMICA,
    ...
    declare indicadores_anoes: List[IndicadorPolitico]  <- [
        IndicadorPolitico(
            tipo <- TipoIndicador.CORRUPCAO_SISTEMICA,
