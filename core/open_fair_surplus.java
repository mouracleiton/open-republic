...
public class Openfairsurplus5QueVoltaPraQuemTrabalha {
    ...
    mais trabalhadores INCENTIVO = mais 5% circulando = mais se sustentando;
    A MATEMATICA:;
    ...
    public static class SurplusFlow {
        // Para onde vai o 5%.
    ...
    public static class ScaleIncentive {
    ...
    // ============================================================================
    // decorador: @dataclass
    public static class FairSurplusCalc {
        ...
        // Producao
        int workers = 0;
        double output_value_month = 0.0 // valor total produzido/mes;
        double worker_pay_month = 0.0 // quanto cada trabalhador recebe;
        // Os 5%
        double surplus_5pct = 0.0 // 5% do valor produzido;
        double surplus_per_worker = 0.0 // quanto cada trabalhador recebe do 5%;
        SurplusFlow surplus_flow = SurplusFlow.COLLECTIVE_POOL;
        // Comparacao com predatorio
        double predatory_90pct = 0.0 // o que o dono levaria no capitalismo;
        double worker_gain_vs_predatory = 0.0 // quanto o trabalhador GANHA trocando;
        // Escala
        double surplus_at_10_workers = 0.0;
        double surplus_at_100_workers = 0.0;
        double surplus_at_1000_workers = 0.0;
        // decorador: @property
        public double worker_total_month(self) {
    ...
    // ============================================================================
    public static class FairSurplusEngine {
        ...
        funcao calculate(self, establishment: texto, est_type: texto,
                    ...
                    SurplusFlow flow = SurplusFlow.COLLECTIVE_POOL;
                    ) -> {texto: qualquer}:;
        ...
        funcao scale_demonstration(self, output_per_worker: flutuante = 4000.0
            ...
            results = [];
            /* TODO: for-each Java para n em scales */
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  OPENFAIRSURPLUS -- 5% QUE VOLTA PRA QUEM TRABALHA");
        System.out.println("  Mais gente trabalhando = mais se sustentando");
        System.out.println("=" * 80);
        // === 1. A DESCOBERTA ===
        System.out.println(""";
    A DESCOBERTA:;
    ...
    // )
        ...
        System.out.println("  Producao por trabalhador: {scale['output_por_trabalhador']}");
        System.out.println("  Surplus: {scale['surplus_pct']}\n");
        System.out.println("  {'Trabalhadores':>15} {'Producao Total':>20} {'5% Circulando':>20} {'Por Trabalhador':>20}");
        System.out.println("  {'-'*80}");
        /* TODO: for-each Java para r em scale["escala"] */
            System.out.println("  {r['trabalhadores']:>15} {r['producao_total']:>20} ";
        ...
        System.out.println("\n  {r1['message']}");
        System.out.println("  Trabalhador total: {r1['trabalhador_recebe_total']}");
        System.out.println("  No capitalismo, dono levaria: {r1['COMPARACAO_PREDATORIA']['capitalismo_dono_leva']}");
        // FabLab
        r2 = engine.calculate("FabLab Central", "construcao",;
                            workers = 20, output_per_worker_month=6000,;
                            worker_pay_month = 3500);
        System.out.println("\n  {r2['message']}");
        System.out.println("  100 trabalhadores: {r2['ESCALA']['100_trabalhadores']}");
        // Software
        ...
        /* TODO: for-each Java para f em flow */
            System.out.println("  {f['destino']:<25} {f['pct']:<15} {f['descricao']}");
        // === 5. COMPARACAO CAPITALISMO vs REPUBLICA ===
        System.out.println("\n\n  === 5. CAPITALISMO vs REPUBLICA ===\n");
        comp = engine.compare_capitalism_vs_republic(4000.0);
        System.out.println("  Producao: {comp['producao_por_trabalhador']}\n");
        System.out.println("  CAPITALISMO:");
        ...
        /* para cada (k, v) em s.items(): */
            System.out.println("  {k:<25} {v}");
        System.out.println("\n{'='*80}");
        System.out.println("  OpenFairSurplus: {s['surplus_definido']} que volta. {s['principio']}");
        System.out.println("{'='*80}");
}
