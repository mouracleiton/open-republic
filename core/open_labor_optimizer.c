...
#ifndef OPENMULTILABOROPTIMIZER_V2_OTIMIZACAO_COM_RETORNOS_DECRESCENTES_H
#define OPENMULTILABOROPTIMIZER_V2_OTIMIZACAO_COM_RETORNOS_DECRESCENTES_H
...
// ============================================================================
double productivity_curve(hours: flutuante) {
...
char* productivity_label(hours: flutuante) {
    if (hours <= 20) {
        return "PEAK";
    } else if (hours <= 35) {
        return "FADIGA";
...
// ============================================================================
// decorador: @dataclass
typedef struct RoleAssignmentV2 {
    role: LaborRole;
...
if (__name__ == "__main__") {
    ...
    printf(optimization_report_v2(all_roles, max_hours=50.0));

#endif // OPENMULTILABOROPTIMIZER_V2_OTIMIZACAO_COM_RETORNOS_DECRESCENTES_H
