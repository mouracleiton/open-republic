...
**Arquivo original:** `core/teia_data_valuation.py`
...
classe DataValueScore:
    ...
    funcao score(self) -> flutuante:
        ...
        retorne soma(values[k] * self.WEIGHTS[k] para k em self.WEIGHTS)

    // decorador: @property
    funcao tier(self) -> texto:
        // Classificacao de valor.
        s = self.score
        se s >= 8.0 entao:
            retorne "DIAMANTE"
        senao se s >= 6.5 entao:
            retorne "OURO"
        senao se s >= 5.0 entao:
            retorne "PRATA"
        senao se s >= 3.5 entao:
            retorne "BRONZE"
        senao:
            retorne "COMMODITY"

    // decorador: @property
    funcao suggested_token_cost(self) -> flutuante:
        ...
        retorne 0.5 * (2 ** (self.score / 2.5))

    // decorador: @property
    funcao suggested_price_brl(self) -> flutuante:
        retorne self.suggested_token_cost * 0.10
...
classe ValuatedDataset:
    ...
    why_valuable: texto
    seja why_not_more: texto = ""


seja DATASETS: [ValuatedDataset] = [
    ...
    ValuatedDataset(
        ...
        why_valuable = (
            "Exclusivo. TEIA e a UNICA fonte no Brasil com 35 politicas "
    ...
    ValuatedDataset(
        ...
        score = DataValueScore(
            scarcity = 6, // VIGISAN e publico, mas cruzamento nao
            demand = 10, // TODO MUNDO precisa saber fome
            freshness = 5, // censo de 2022, atualiza em 5 anos
            exclusivity = 7, // dado bruto publico, cruzamento e exclusivo
        ...
        why_valuable = (
            "Alto impacto + alta demanda. Dado bruto (VIGISAN) e publico, "
            "mas o CRUZAMENTO por municipio com CADunico, saneamento e "
            "educacao so TEIA fez. Jornalista/prefeito nao consegue sozinho."
        ),
        why_not_more = "Dado bruto e publico. Qualquer um pode baixar VIGISAN.",
    ),
    ...
    ValuatedDataset(
        ...
        description = "Perfil de negativados por regiao e renda",
        source = "SPC/Boa Vista/Peic 2024",
        score = DataValueScore(
            scarcity = 7, // SPC nao e gratis, precisa pagar
        ...
        why_not_more = "Dado base ja e comercializado por SPC/Serasa.",
    ),
    ...
    ValuatedDataset(
        ...
        why_valuable = (
            ...
            "Mas SNIS e publico. Valor do TEIA: cruza com impacto sanitario."
        ),
        why_not_more = "SNIS e publico. So o cruzamento e exclusivo.",
    ),
    ...
    ValuatedDataset(
        ...
        score = DataValueScore(
            scarcity = 3, // CAGED e totalmente publico e facil
            demand = 7, // jornalistas e economistas
            freshness = 8, // mensal
            exclusivity = 2, // todo mundo tem CAGED
            decision_impact = 5, // informativo mas nao habilita decisao direta
            connection = 6,
            risk_prevention = 3,
        ),
        current_token_cost = 0.5,
        why_valuable = (
            "Demanda alta mas zero exclusividade. CAGED e publico, facil de baixar. "
            "TEIA so adiciona conveniencia (nao precisa baixar/limpar)."
        ),
    ...
    ValuatedDataset(
        ...
        current_token_cost = 0.5,
        why_valuable = "INEP e publico e facil. Valor do TEIA e so conveniencia.",
    ...
    ValuatedDataset(
        ...
        current_token_cost = 0.8,
        why_valuable = "Conveniencia. Dado bruto e publico e facil.",
...
funcao print_valuation() -> texto:
    ...
    para cada (name, weight) em DataValueScore.WEIGHTS.items():
        desc = {
            ...
            "exclusivity": "So TEIA tem? Modelo de impacto = sim. IBGE = nao.",
    ...
    lines.append("")
    lines.append("    IBGE puro (todo mundo tem, nao habilita decisao) = R$0,05")
    ...
    para cada d em ranked:
        ...
        se delta > current * 0.5 entao:
            action = "SUBIR PRECO (subvalorizado)"
        senao se delta < -current * 0.3 entao:
