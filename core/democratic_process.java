...
public class OpenrepublicPrincipioDemocraciaNaoElitismo {
    ...
    public static class ProposalOrigin {
    ...
    public static class Proposal {
        ...
        // Verificacao
        boolean anti_elitism_check = false // passou verificacao anti-elitismo;
        boolean co_created = false // mais de 1 pessoa participou da criacao;
    public static class DemocraticProcess {
        ...
        public {texto: qualquer} start_voting(self, proposal_id: texto) {
        ...
        public void cast_vote(self, proposal_id: texto, vote: texto) {
        ...
        funcao tally(self, proposal_id: texto,
                boolean constitutional = false) -> {texto: qualquer}:;
            // Apurar votacao.
            p = self.proposals.get(proposal_id);
            if (! p) {
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  OPENREPUBLIC -- DEMOCRACIA, NAO ELITISMO");
        System.out.println("  'Ninguem decide por todos. Todos decidem por todos.'");
        System.out.println("=" * 80);
        ...
        System.out.println("  Proposta: {prop.proposal_id}");
        System.out.println("  Titulo: {prop.title}");
        System.out.println("  Proponente: {prop.proposer_name}");
        System.out.println("  Status: {prop.status.value}");
        System.out.println("  Verificacao anti-elitismo: {'PASSOU' if prop.anti_elitism_check else 'FALHOU'}");
        System.out.println("  Setores afetados: {prop.affects_sectors}");
        // === Debate ===
        ...
        process.add_debate_comment(prop.proposal_id, "C-005", "Kofi",;
            ...
            is_concern = false);
        System.out.println("  Comentarios de debate: {len(prop.debate_comments)}");
        /* TODO: for-each Java para c em prop.debate_comments */
            flag = c["is_concern"] ? "[CONCERNO]" : "[APOIO]";
            System.out.println("    {flag} {c['citizen']}: {c['comment'][:70]}...");
        ...
        votes = ["sim", "sim", "sim", "!", "sim", "!", "sim", "sim",;
                "sim", "sim", "!", "sim"];
        /* TODO: for-each Java para v em votes */
            process.cast_vote(prop.proposal_id, v);
        result = process.tally(prop.proposal_id);
        System.out.println("  Proposta: {result['proposal']}");
        ...
        System.out.println("  Se o proponente diz 'eu decidi construir X':");
        System.out.println("    -> Proposta REJEITADA por anti-democratica.");
        System.out.println("    -> Ninguem decide. Propoe.");
        System.out.println("    -> O coletivo decide.");
        System.out.println("  Se o proponente diz 'eu proponho construir X':");
        System.out.println("    -> Proposta ACEITA para debate.");
        System.out.println("    -> O coletivo debate.");
        System.out.println("    -> O coletivo vota.");
        System.out.println("    -> O coletivo decide.");
        // === Case 3: Emergency ===
        ...
        System.out.println("  Proposta: {emergency.proposal_id}");
        System.out.println("  Tipo: {emergency.ptype.value}");
        System.out.println("  Origem: {emergency.origin.value}");
        System.out.println("  Processo: ACELERADO (votacao em 24h)");
        System.out.println("  Auto-expira em 30 dias se ! revalidada");
        // === Constitution ===
        System.out.println("\n\n{'='*80}");
        System.out.println("  PRINCIPIO CONSTITUCIONAL: DEMOCRACIA > IDEIA");
        System.out.println("{'='*80}");
        System.out.println(""";
    PRINCIPIO CONSTITUCIONAL NUMERO 1:;
        "Nenhuma ideia, projeto, sistema || mudanca entra na Republica;
