...
package openmultilaboroptimizer_v2_otimizacao_com_retornos_decrescentes
...
Formula := taxa * sinergia * foco * CURVA(horas) // valor_hora
...
// ============================================================================
func productivity_curve(hours: flutuante) float64 {
...
func productivity_label(hours: flutuante) string {
    if hours <= 20 {
        return "PEAK"
    } else if hours <= 35 {
        return "FADIGA"
...
if __name__ == "__main__" {
    ...
    fmt.Println(optimization_report_v2(all_roles, max_hours=50.0))
