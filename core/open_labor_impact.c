...
#ifndef OPENLABORIMPACT_OTIMIZACAO_POR_IMPACTO_NAO_DINHEIRO_H
#define OPENLABORIMPACT_OTIMIZACAO_POR_IMPACTO_NAO_DINHEIRO_H
...
funcao optimize_impact(
    ...
    impact_per_hour = {};
    /* TODO: iterador C manual para role em all_roles */
        im = IMPACT_DATA[role];
        impact_per_hour[role] = im.vte / 20.0 // VTE/hora a produtividade maxima;
    /* TODO: iterador C manual para k em intervalo(min_roles, n + 1) */
        /* TODO: iterador C manual para combo em itertools.combinations(intervalo(n), k) */
            ...
            assignments = [];
            /* TODO: iterador C manual para role em selected_roles */
...
if (__name__ == "__main__") {
    ...
    printf(impact_optimization_report(all_roles, max_hours=50.0));

#endif // OPENLABORIMPACT_OTIMIZACAO_POR_IMPACTO_NAO_DINHEIRO_H
