...
public class OpensurplusMetricaDeNecessidadeDeExcedentePorEstabelecimento {
    ...
    public static class SurplusDestination {
    ...
    // ============================================================================
    // decorador: @dataclass
    public static class SurplusMetric {
        ...
        // No modo IDEAL
        String ideal_equivalent = ""  // como funciona sem excedente;
        ...
        String excedente_predatorio_exemplo = "";
        // decorador: @property
        public double excedente_necessario_total(self) {
            return (self.custo_operacional_pct + self.investimento_justo_pct;
                    + self.reserva_pct + self.comunitario_pct);
        // decorador: @property
        public double max_predatorio_pct(self) {
            return maximo(0.0, 1.0 - self.excedente_necessario_total);
        // decorador: @property
        public double trabalhador_recebe_pct(self) {
    ...
    // ============================================================================
    // decorador: @dataclass
    public static class SurplusCalculation {
    ...
    public static class SurplusEngine {
        ...
        public {texto: qualquer} get_metric(self, est_type: EstablishmentType) {
        ...
        public {texto: qualquer} ideal_mode_equivalent(self, est_type: EstablishmentType) {
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  OPENSURPLUS -- METRICA DE EXCEDENTE POR ESTABELECIMENTO");
        System.out.println("  Quanto excedente && NECESSARIO vs PREDATORIO?");
        System.out.println("=" * 80);
        // === 1. METRICAS POR TIPO ===
        System.out.println("\n\n  === 1. LIMITES DE EXCEDENTE POR TIPO ===\n");
        System.out.println("  {'Tipo':<25} {'Necessario':>12} {'Max Justo':>12} {'Trab. recebe':>14} {'Acima &&':>10}");
        System.out.println("  {'-'*75}");
        /* TODO: for-each Java para c em engine.compare_all() */
            System.out.println("  {c['tipo']:<25} {c['necessario']:>12} {c['max_justo']:>12} ";
                "{c['trabalhador_recebe']:>14} {c['acima_e_predatorio']:>10}");
        // === 2. DETALHE: HOSPITAL ===
        System.out.println("\n\n  === 2. DETALHE: HOSPITAL/CLINICA ===\n");
        hosp = engine.get_metric(EstablishmentType.SAUDE);
        System.out.println("  Excedente necessario: {hosp['excedente_necessario']}");
        System.out.println("  Trabalhador recebe: {hosp['trabalhador_recebe']}");
        System.out.println("  Limite predatorio: {hosp['limite_predatorio']}");
        System.out.println("\n  Custo operacional:");
        /* para cada (k, v) em hosp["detalhe_operacional"].items(): */
            System.out.println("    {k:<15} {v}");
        ...
        System.out.println("  Cada trabalhador: produz {r1['cada_trabalhador']['produz']}, ";
        ...
        System.out.println("  Razao exploracao: {r2['cada_trabalhador']['razao_exploracao']}");
        ...
        /* para et em [EstablishmentType.SAUDE, EstablishmentType.SOFTWARE, */
            ...
            System.out.println("\n  {ideal['tipo']}:");
            System.out.println("    Excedente: {ideal['excedente']}");
            System.out.println("    Trabalhador: {ideal['trabalhador_recebe']}");
            System.out.println("    {ideal['ideal'][:70]}...");
        // === 5. STATS ===
        System.out.println("\n\n  === 5. ESTATISTICAS ===\n");
        s = engine.stats();
        ...
        System.out.println("\n{'='*80}");
        System.out.println("  OpenSurplus: {s['tipos_cadastrados']} tipos, ";
