...
#ifndef OPENVALUEFLOW_ELIMINAR_EMPRESA_E_BANCO_DA_CADEIA_DE_VALOR_H
#define OPENVALUEFLOW_ELIMINAR_EMPRESA_E_BANCO_DA_CADEIA_DE_VALOR_H
...
// ============================================================================
// decorador: @dataclass
typedef struct ValueChainAnalysis {
...
// ============================================================================
typedef struct ValueFlowEngine {
    ...
    {texto: qualquer} bank_extraction_detail(self) {
    ...
    {texto: qualquer} company_extraction_detail(self) {
    ...
    {texto: qualquer} full_comparison(self, total_value: flutuante = 100.0) {
    ...
    {texto: qualquer} stats(self) {
        return {;
            "analises_feitas": sizeof(self.analyses),;
...
// )
    ...
    /* para cada (k, v) em s.items(): */
        printf("  {k:<30} {v}");
    printf("\n{'='*80}");
    printf("  OpenValueFlow: {s['analises_feitas']} analises.");
    printf("  {s['principio']}");
    printf("{'='*80}");

#endif // OPENVALUEFLOW_ELIMINAR_EMPRESA_E_BANCO_DA_CADEIA_DE_VALOR_H
