...
public class OpenconstituentassemblyAssembleiaConstituinte {
    ...
    public static class Constituent {
        ...
        age: inteiro;
        boolean is_founder = false;
        public Object vote_on(self, prop: Proposition) {
        ...
        public Object _demographic_vote(self, prop: Proposition) {
    ...
    public static class ConstituentAssembly {
        ...
        public None populate(self, n: inteiro = 10000) {
            ...
            /* TODO: for-each Java para i em intervalo(n - 1) */
        ...
        public None _init_propositions(self) {
            ...
            /* TODO: for-each Java para p em props */
        ...
        public {texto: qualquer} run_election(self) {
            ...
            //
            /* TODO: for-each Java para prop em self.propositions.values() */
                votes = Counter();
                /* TODO: for-each Java para constituent em self.constituents */
        ...
        public String results_report(self) {
            ...
            lines.append("  {'='*80}");
            return "\n".join(lines);
        public String constitution_text(self) {
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  CONVOCAÇÃO DA ASSEMBLEIA CONSTITUINTE");
        System.out.println("=" * 80);
        System.out.println(""";
    O FUNDADOR DECLARA:;
    ...
    // )
        ...
        System.out.println("  População convocada: {len(assembly.constituents):,} cidadaos");
        System.out.println("  Propostas a votar: {len(assembly.propositions)}");
        System.out.println("  Demográficos representados: {len(set(c.demographic for c in assembly.constituents))}");
        ...
        /* para cada (demo, count) em ordene(demo_dist.items(), key=(x) -> -x[1]): */
            ...
            System.out.println("    {demo:<20} {count:>5,} ({pct:>5.1f}%)");
        // Votação
        System.out.println("\n\n  VOTAÇÃO EM ANDAMENTO...\n");
        assembly.run_election();
        // Relatório
        System.out.println(assembly.results_report());
        // Constituição final
        System.out.println("\n\n");
        System.out.println(assembly.constitution_text());
        // Reflexão final
