...
#ifndef TEIA_DATAVALUATION_NEM_TODO_DADO_VALE_O_MESMO_H
#define TEIA_DATAVALUATION_NEM_TODO_DADO_VALE_O_MESMO_H
...
typedef struct DataValueScore {
    ...
    char* tier(self) {
        ...
        if (s >= 8.0) {
            ...
            return "COMMODITY";
    // decorador: @property
    double suggested_token_cost(self) {
...
char* print_valuation(void) {
    ...
    lines.append("-" * 115);
    /* TODO: iterador C manual para d em ranked */
        s = d.score;
    ...
    /* TODO: iterador C manual para tier em tiers */
        ...
        lines.append("-" * 115);
        /* TODO: iterador C manual para d em tier_data */
            s = d.score;
            lines.append("");
...
if (__name__ == "__main__") {
    printf(print_valuation());

#endif // TEIA_DATAVALUATION_NEM_TODO_DADO_VALE_O_MESMO_H
