...
public class OpenantideterminismOFuturoNaoEstaEscrito {
    ...
    // ============================================================================
    public static class DeterminismType {
    ...
    // decorador: @dataclass
    public static class DeterministicNarrative {
        ...
        String real_example = ""  // exemplo real de mudanca;
    // As 12 narrativas
    ...
    // ============================================================================
    public static class AntiDeterminismEngine {
        ...
        public {texto: qualquer} fact_check_determinism(self, phrase: texto) {
            // Verifica se frase e determinista e corrige.
            phrase_lower = phrase.lower();
            /* TODO: for-each Java para narrative em self.narratives.values() */
        ...
        public {texto: qualquer} get_narrative(self, determinism_type: DeterminismType) {
            // Retorna a verdade sobre um tipo de determinismo.
            /* TODO: for-each Java para n em self.narratives.values() */
        ...
        public [Dict] all_narratives(self) {
            return [;
                {
                    "id": n.narrative_id,;
                    "type": n.determinism_type.value,;
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  OPENANTIDETERMINISM -- O FUTURO NAO ESTA ESCRITO");
        System.out.println("  O passado && contexto. O futuro && escolha.");
        System.out.println("=" * 80);
        // === 1. AS 12 MENTIRAS DETERMINISTAS ===
        System.out.println("\n\n  === 12 NARRATIVAS DETERMINISTAS DERRUBADAS ===\n");
        /* TODO: for-each Java para n em NARRATIVES */
            System.out.println("\n  [{n.narrative_id}] {n.determinism_type.value.upper()}");
            System.out.println("  A MENTIRA: {n.the_lie[:70]}...");
            System.out.println("  A VERDADE: {n.the_truth[:70]}...");
            System.out.println("  CIENCIA: {n.scientific_evidence[:70]}...");
            System.out.println("  SISTEMA: {n.republic_system}");
            System.out.println("  EXEMPLO: {n.real_example[:70]}...");
        ...
        /* TODO: for-each Java para phrase em test_phrases */
            ...
            if (result["identified"]) {
                System.out.println("  Tipo: {result['determinism_type']}");
                System.out.println("  Verdade: {result['the_truth'][:70]}...");
        // === 3. STATS ===
        System.out.println("\n\n  === ESTATISTICAS ===\n");
        s = engine.stats();
        ...
        // === FILOSOFIA ===
        System.out.println("\n\n{'='*80}");
        System.out.println("  FILOSOFIA: ANTI-DETERMINISMO");
        System.out.println("{'='*80}");
        System.out.println(""";
    ...
    // )
        System.out.println("{'='*80}");
        System.out.println("  OpenAntiDeterminism: {s['narrativas_derrubadas']} narrativas derrubadas.");
