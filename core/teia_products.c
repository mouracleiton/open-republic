...
#ifndef TEIA_PORTFOLIO_DE_PRODUTOS_DE_INTELIGENCIA_ESTRATEGICA_H
#define TEIA_PORTFOLIO_DE_PRODUTOS_DE_INTELIGENCIA_ESTRATEGICA_H
...
// ============================================================================
typedef struct DeliverySpeed {
    IMO = "imediato (produto pronto)";
    DAYS = "dias (1-7)";
    WEEKS = "semanas (1-4)";
    MONTHS = "meses (1-3)";
typedef struct Exclusivity {
...
typedef struct DataProduct {
    ...
    double margin_pct = 90 // margem (trabalho intelectual tem custo baixo);
// OS 10 FORMATOS
...
char* print_portfolio(void) {
    ...
    total_rec_min = 0;
    total_rec_max = 0;
    /* TODO: iterador C manual para p em recurring */
    ...
    /* TODO: iterador C manual para p em oneshot */
...
if (__name__ == "__main__") {
    printf(print_portfolio());

#endif // TEIA_PORTFOLIO_DE_PRODUTOS_DE_INTELIGENCIA_ESTRATEGICA_H
