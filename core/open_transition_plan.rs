...
enum Phase {
    ...
    fn __init__(self, label, timeline, goal) {
        self.label = label;
...
struct Action {
    ...
    title: texto;
    description: texto;
    let owner: String = "cleiton";
    let deadline_days: i64 = 30;
    let cost_brl: f64 = 0;
    let revenue_potential_brl: f64 = 0;
...
struct FinancialProjection {
    ...
    phase: Phase;
    let consulting_revenue: f64 = 0 // hibrido;
    let product_revenue: f64 = 0 // autofinanciamento (TEIA, etc);
    let cooperative_revenue: f64 = 0 // cooperativa;
    let costs: f64 = 0;
    let net: f64 = 0;
    fn calculate(self) {
...
// ============================================================================
fn financial_projections() -> [FinancialProjection] {
