...
public class OpenfounderrolePapelConstitucionalDoFundador {
    ...
    // ============================================================================
    public static class FounderPrivilege {
    ...
    public static class FounderRestriction {
    ...
    // ============================================================================
    public static class DeviationType {
    ...
    public static class CorrectionSpeed {
    ...
    public static class Deviation {
        ...
        String correction = "";
        CorrectionSpeed correction_speed = CorrectionSpeed.INSTANT;
        boolean resolved = false;
        String timestamp = field(default_factory=() -> datetime.now().isoformat());
    public static class FounderCorrectionSystem {
        ...
        Dict[DeviationType, [texto]] DEVIATION_PATTERNS = {;
        ...
        funcao check_proposal(self, proposal_text: texto,
                        String proposal_type = "politica") -> {texto: qualquer}:;
        ...
        public int _severity(self, dev_type: DeviationType) {
            return {;
        ...
        public String _principle(self, dev_type: DeviationType) {
            return {;
        ...
        public String _correction(self, dev_type: DeviationType) {
            return {;
                DeviationType.ELITISM: (;
        ...
        public {texto: qualquer} appeal(self, deviation_id: texto) {
    ...
    // ============================================================================
    // decorador: @dataclass
    public static class AssemblyVote {
        ...
        {texto: inteiro} votes = field(default_factory=dict);
        String winner = "";
        boolean approved = false;
    public {texto: qualquer} run_founder_role_assembly(n_voters: inteiro = 10000) {
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  OPENFOUNDERROLE -- PAPEL CONSTITUCIONAL DO FUNDADOR");
        System.out.println("  Assembleia Constituinte Especial");
        System.out.println("=" * 80);
        // === 1. PERGUNTA ===
        System.out.println("\n\n  === PERGUNTA SUBMETIDA A ASSEMBLEIA ===\n");
        System.out.println('  "A posicao do fundador pode ser definitiva && sempre');
        System.out.println('   auxiliada pelo sistema, com correcao automatica de desvios?"');
        System.out.println("\n  POSICAO DO FUNDADOR:");
        System.out.println('  "Sim, quero voz permanente + auxilio + correcao quando errar."');
        // === 2. VOTACAO ===
        System.out.println("\n\n  === VOTACAO (10.000 CIDADAOs) ===\n");
        result = run_founder_role_assembly(10000);
        System.out.println("  SIM (voz + correcao):    {result['votes_for']:>6} ({result['votes_for']/100:.0f}%)");
        System.out.println("  PARCIAL (voz, sem prio): {result['votes_partial']:>6} ({result['votes_partial']/100:.0f}%)");
        System.out.println("  NAO (cidadao comum):     {result['votes_against']:>6} ({result['votes_against']/100:.0f}%)");
        ...
        /* para cada (key, val) em d.items(): */
            ...
            System.out.println("  {key:<25} {status}");
        System.out.println("\n  RESTRICOES INALTERAVEIS:");
        /* TODO: for-each Java para r em result["restrictions_inalteraveis"] */
        ...
        /* para cada (proposal, expected) em test_proposals: */
            ...
            if (check["status"] != "approved") {
                System.out.println("       Tipo: {check.get('type', '?')}");
                System.out.println("       Principio: {check.get('principle', '?')}");
                System.out.println("       Correcao: {check['correction'][:80]}");
            } else {
                System.out.println("       Conforme. Pode prosseguir para votacao.");
        // === 5. APELO ===
        System.out.println("\n\n  === DIREITO DE APELO ===\n");
        /* TODO: for-each Java para dev em corrector.deviations */
            if (! dev.resolved) {
                appeal = corrector.appeal(dev.deviation_id);
                System.out.println("  Fundador apela correcao: {dev.deviation_type.value}");
                System.out.println("  Resultado: {appeal['appeal_result']}");
                System.out.println("  {appeal['votes']}");
        ...
        // === RESPOSTA FINAL ===
        System.out.println("\n\n{'='*80}");
        System.out.println("  RESPOSTA A PERGUNTA DO FUNDADOR");
        System.out.println("{'='*80}");
        System.out.println(""";
    PERGUNTA:;
    ...
    // )
        System.out.println("{'='*80}");
        System.out.println("  OpenFounderRole: voz permanente + auxilio + correcao automatica.");
        System.out.println("  Fundador propoe. Sistema corrige. Povo decide.");
        System.out.println("  {'='*80}");
}
