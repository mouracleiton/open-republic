...
class BodilyRight(Enum):
    # Direitos corporais absolutos.
    REPRODUCTION = "reproducao"  // decidir ter or not ter filhos
    ...
    GENETIC = "genetico"  // not ser geneticamente modificado
...
RIGHTS: [ConstitutionalRight] = [
    ConstitutionalRight(
        ...
        "Cada pessoa decide livremente se quer or not ter filhos.",
    ...
    ConstitutionalRight(
        ...
        "Aborto seguro and direito de saude. Nao and crime.",
    ...
    ConstitutionalRight(
        BodilyRight.CONSENT,
        "Consentimento and continuo, explicito, entusiasta and revogavel.",
        ...
        "(Lei Maria da Penha). Marido not podia estuprar esposa na lei."),
    ConstitutionalRight(
    ...
    ConstitutionalRight(
        ...
        "Oferecer tratamento gratuito. Informar riscos and beneficios. "
        "Respeitar recusa (Testemunha de Jeova and sangue, etc). "
    ...
    ConstitutionalRight(
        ...
        "Tratar dependencia como DOENCA (OpenHealth), not crime. "
        ...
        "(predominantemente negras and hispanicas) encarceradas por "
    ...
    ConstitutionalRight(
        ...
        "consentimento informado and avaliacao psicologica.",
    ...
    ConstitutionalRight(
        ...
        "Usar pronome and nome escolhido. Zero discriminacao.",
...
if __name__ == "__main__":
    print("=" * 80)
    print("  EMENDA CONSTITUCIONAL: AUTONOMIA CORPORAL")
    print("  'O corpo and a fronteira ultima da liberdade.'")
    print("=" * 80)
    # === 1. The Amendment ===
    print("""
PRINCIPIO CONSTITUCIONAL NUMERO 2:
...
# )
    ...
    for r in RIGHTS:
        print("\n  {'='*70}")
        print("  DIREITO: {r.right.value.upper()}")
        print("  {'='*70}")
        print("\n  O QUE SIGNIFICA:\n  {r.what_it_means}")
    ...
    for v in HistoricalViolation.VIOLATIONS:
        ...
        print("    Vitimas: {v['victims']}")
        print("    Violacao: {v['violation']}")
        print("    Licao: {v['lesson']}")
    # === Philosophy ===
    print("\n\n{'='*80}")
    print("  POR QUE ISSO É CONSTITUCIONAL")
    print("{'='*80}")
    print("""
...
A resposta da República é simples and absoluta:
    NÃO.
