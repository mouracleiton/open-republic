...
public class TeiaApiEconomyMicropagamentosPorChamadaComRoyaltyChain {
    ...
    public static class ContributionType {
        ...
        public void __init__(self, key: texto, description: texto, default_weight: flutuante) {
            self.key = key;
    ...
    public static class Contribution {
        ...
        String description = "";
        // decorador: @property
        public double effective_weight(self) {
    ...
    public static class APIEndpoint {
        ...
        // decorador: @property
        public int n_contributors(self) {
            return tamanho(set(c.contributor_id para c em self.contributions));
        // decorador: @property
        public double total_weight(self) {
            return soma(c.effective_weight para c em self.contributions);
        public double contributor_share(self, contributor_id: texto) {
        ...
        funcao revenue_split(self) retorna List[{texto: qualquer}]:
            ...
            /* TODO: for-each Java para c em self.contributions */
    ...
    public static class TEIAAPI {
        ...
        public void _register_endpoints(self) {
        ...
        public {texto: qualquer} call(self, endpoint_id: texto, n_calls: inteiro = 1) {
    ...
    public static class RoyaltyTracker {
        ...
        public void register_calls(self, endpoint_id: texto, n_calls: inteiro) {
            ...
            return result;
        public void register_daily_traffic(self, calls_per_endpoint: {texto: inteiro}) {
            // Simula um dia de trafego.
            /* para cada (eid, n) em calls_per_endpoint.items(): */
                self.register_calls(eid, n);
        public String earnings_report(self) {
            ...
            return "\n".join(lines);
        public String revenue_per_endpoint_detail(self) {
    ...
    // ============================================================================
    public String simulate_traffic() {
        ...
        // Simular 90 dias
        /* TODO: for-each Java para _ em intervalo(89) */
            tracker.register_daily_traffic(traffic_m1);
        ...
        /* TODO: for-each Java para _ em intervalo(90) */
        ...
        /* TODO: for-each Java para _ em intervalo(180) */
    ...
    if (__name__ == "__main__") {
        System.out.println(simulate_traffic());
}
