...
public class OpenseniorityNiveisDeSenioridadePorImpactoNaoHierarquia {
    ...
    // 1. OS 7 NIVEIS
    // ============================================================================
    public static class SeniorityLevel {
    ...
    public static class PromotionCriteria {
        ...
        [texto] requirements = field(default_factory=list);
        [texto] evidence_required = field(default_factory=list);
        String review_by = "";
    {SeniorityLevel: PromotionCriteria} PROMOTION_CRITERIA = {;
    ...
    // 3. TABELA DE NIVEIS
    // ============================================================================
    public String print_seniority_table() {
    ...
    // ============================================================================
    // decorador: @dataclass
    public static class CompensationCalc {
        // Calcula compensacao por nivel, horas, e modo (Ideal vs Executavel).
        level: SeniorityLevel;
        double hours_per_week = 20.0 // Base 1.0 = 20h/semana;
        int weeks_per_year = 46;
        // decorador: @property
        public double hours_per_year(self) {
            return self.hours_per_week * self.weeks_per_year;
        // decorador: @property
        public double hours_per_month(self) {
    ...
    // ============================================================================
    public String map_to_labor_tier(level: SeniorityLevel) {
    ...
    // ============================================================================
    public void anti_elitism_check(level: SeniorityLevel, stated_by_self: logico = False) retorna (logico, texto) {
    ...
    if (__name__ == "__main__") {
        System.out.println(print_seniority_table());
        System.out.println();
        // Demo: compensacao em cada nivel
        System.out.println();
        System.out.println("DEMO -- Compensacao por nivel (20h/semana, Base 1.0):");
        ...
        System.out.println();
        System.out.println("DEMO -- Compensacao N6 em carga cheia (40h/semana):");
        System.out.println("-" * 70);
        calc_n6 = CompensationCalc(level=SeniorityLevel.N6, hours_per_week=40.0);
        System.out.println(calc_n6.summary());
        System.out.println();
        System.out.println("DEMO -- Anti-elitismo:");
        System.out.println("-" * 70);
        /* TODO: for-each Java para level em SeniorityLevel */
            desempacote approved, msg = anti_elitism_check(level, stated_by_self=true);
            status = approved ? "OK" : "BLOQUEADO";
            System.out.println("  N{level.name[1]} autodeclarado: [{status}] {msg}");
}
