...
public class OpenlaborimpactOtimizacaoPorImpactoNaoDinheiro {
    ...
    public static class ImpactMetrics {
        ...
        String evidence = ""  // justificativa;
        // decorador: @property
        public double vte(self) {
        ...
        // decorador: @property
        public String vte_formatted(self) {
            v = self.vte;
            if (v >= 1_000_000) {
    ...
    {LaborRole: ImpactMetrics} IMPACT_DATA = {;
    ...
    // decorador: @dataclass
    public static class ImpactProfile {
        // Perfil otimizado por impacto, nao dinheiro.
        String citizen_id = "";
        [ImpactRoleAssignment] roles = field(default_factory=list);
        ...
        public String _fmt_vte(v: flutuante) {
            if (v >= 1_000_000) {
    ...
    funcao optimize_impact(
        ...
        impact_per_hour = {};
        /* TODO: for-each Java para role em all_roles */
            im = IMPACT_DATA[role];
        ...
        /* TODO: for-each Java para k em intervalo(min_roles, n + 1) */
            /* TODO: for-each Java para combo em itertools.combinations(intervalo(n), k) */
                ...
                assignments = [];
                /* TODO: for-each Java para role em selected_roles */
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println(impact_optimization_report(all_roles, max_hours=50.0));
}
