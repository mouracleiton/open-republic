...
public class TeiaDatavaluationNemTodoDadoValeOMesmo {
    ...
    // ============================================================================
    // decorador: @dataclass
    public static class DataValueScore {
        ...
        public String tier(self) {
            ...
            if (s >= 8.0) {
                ...
                return "COMMODITY";
        // decorador: @property
        public double suggested_token_cost(self) {
        ...
        // decorador: @property
        public double suggested_price_brl(self) {
            return self.suggested_token_cost * 0.10;
    // ============================================================================
    // 2. CATALOGO DE DADOS AVALIADOS
    // ============================================================================
    // decorador: @dataclass
    public static class ValuatedDataset {
        endpoint: texto;
        description: texto;
        source: texto;
    ...
    public String print_valuation() {
        ...
        lines.append("-" * 115);
        /* TODO: for-each Java para d em ranked */
            s = d.score;
        ...
        /* TODO: for-each Java para tier em tiers */
            ...
            lines.append("-" * 115);
            /* TODO: for-each Java para d em tier_data */
                s = d.score;
                lines.append("");
    ...
    if (__name__ == "__main__") {
        System.out.println(print_valuation());
}
