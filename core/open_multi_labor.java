...
public class OpenmultilaborCalculoDePerfisMultiLaborPoliAtuacao {
    ...
    public static class LaborRole {
        ...
        public void __init__(self, label: texto, nature: texto, evidence: texto) {
            self.label = label;
            self.nature = nature;
    ...
    // ============================================================================
    public double synergy_multiplier(role_a: LaborRole, role_b: LaborRole) {
    ...
    // 3. FOCO PENALTY
    // ============================================================================
    public double focus_penalty(n_roles: inteiro) {
        if (n_roles <= 1) {
            return 1.0;
    ...
    public static class RoleAssignment {
        ...
        // decorador: @property
        public double base_value_weekly(self) {
            return self.base_rate * self.hours_per_week;
    // decorador: @dataclass
    public static class MultiLaborProfile {
        String citizen_id = "";
        ...
        public String summary(self) {
            ...
            lines.append("-" * 110);
            /* TODO: for-each Java para ra em self.roles */
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println(cleiton.summary());
}
