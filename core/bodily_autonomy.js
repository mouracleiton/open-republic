...
if (__name__ == "__main__") {
    console.log("=" * 80);
    console.log("  EMENDA CONSTITUCIONAL: AUTONOMIA CORPORAL");
    console.log("  'O corpo && a fronteira ultima da liberdade.'");
    console.log("=" * 80);
    // === 1. The Amendment ===
    console.log(""";
PRINCIPIO CONSTITUCIONAL NUMERO 2:;
...
// )
    ...
    for (const r of RIGHTS) {
        console.log("\n  {'='*70}");
        console.log("  DIREITO: {r.right.value.upper()}");
        console.log("  {'='*70}");
        console.log("\n  O QUE SIGNIFICA:\n  {r.what_it_means}");
    ...
    for (const v of HistoricalViolation.VIOLATIONS) {
        console.log("\n  {v['perpetrator']} ({v['country']}, {v['era']})");
        console.log("    Vitimas: {v['victims']}");
        console.log("    Violacao: {v['violation']}");
        console.log("    Licao: {v['lesson']}");
    // === Philosophy ===
    console.log("\n\n{'='*80}");
    console.log("  POR QUE ISSO É CONSTITUCIONAL");
    console.log("{'='*80}");
    console.log(""";
