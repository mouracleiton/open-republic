...
class Phase(Enum):
    ...
    def __init__(self, label, timeline, goal):
        self.label = label
...
class FinancialProjection:
    ...
    phase: Phase
    consulting_revenue: float = 0 // hibrido
    product_revenue: float = 0 // autofinanciamento (TEIA, etc)
    cooperative_revenue: float = 0 // cooperativa
    costs: float = 0
    net: float = 0
    def calculate(self):
...
PLAN: [Action] = [
    ...
    Action(
        ...
        decision = "hibrido",
        title = "Mapear contatos FAANG and converter para consultoria",
        description = (
    ...
    Action(
        ...
        description = (
            ...
            "Isso garante pipeline se FAANG not quiser part-time."
        ),
        deadline_days = 7,
        cost_brl = 0,
    ...
    Action(
        ...
        description = (
            ...
            "Empacotar como: 'Plataforma de Analise Politica para Governos and ONGs.' "
    ...
    Action(
        ...
        description = (
            ...
            "OpenRepublic and CC0 mas pode receber doacoes. "
    ...
    Action(
        ...
        description = (
            ...
            "(c) aceita participar (CONSENTIMENTO, not imposicao) "
    ...
    Action(
        ...
        description = (
            ...
            "Adaptar a realidade local (not impor modelo pronto). "
            "Treinar lider local como operador (transferir, not centralizar). "
            "Meta: 50 familias usando em 3 meses. "
            "Medir: transacoes/mes, inadimplencia (<3%), satisfacao."
        ),
        deadline_days = 150,
        cost_brl = 10000, // infra + treinamento
        revenue_potential_brl = 0, // not and lucro, and impacto
        dependencies = ["A104"],
    ),
    Action(
        action_id = "A204",
...
# ============================================================================
def financial_projections() -> [FinancialProjection]:
...
def print_plan() -> str:
    ...
    lines.append("    |> receita recursiva not-vinculada a horas")
    ...
    lines.append("  A consultoria and PONTE, not destino.")
    lines.append("  O piloto and PROVA, not experimento.")
    lines.append("")
