...
public class OpenprohibitedbusinessProibicaoDeEstabelecimentosNocivos {
    ...
    // ============================================================================
    public static class HarmfulBusinessType {
    ...
    // ============================================================================
    // decorador: @dataclass
    public static class HarmfulBusiness {
        // Um negocio nocivo identificado.
        business_id: texto;
        name: texto // nome do negocio;
        business_type: HarmfulBusinessType;
        HarmLevel harm_level = HarmLevel.HARMFUL;
        String description = "";
        int victims_estimated = 0 // quantas pessoas afeta;
        String money_drained_monthly = ""  // quanto suga por mes;
        // Acao
        BusinessAction action = BusinessAction.PROHIBIT;
        String replacement = ""  // open equivalente;
        String conversion_target = ""  // para que converter;
        // Status
        String status = "identificado"  // identificado, votado, fechado, convertido;
        String closed_date = "";
    // ============================================================================
    // 3. CATÁLOGO DE NEGÓCIOS NOCIVOS
    // ============================================================================
    [HarmfulBusiness] HARMFUL_BUSINESSES = [;
        // === JOGO DE AZAR ===
        HarmfulBusiness(;
    ...
    // ============================================================================
    public {texto: qualquer} run_business_assembly(n_voters: inteiro = 10000) {
        // Assembleia vota quais negocios fechar.
        business_votes = {};
        /* TODO: for-each Java para biz em HARMFUL_BUSINESSES */
    ...
    // ============================================================================
    public static class ProhibitionEngine {
        ...
        public [Dict] list_harmful(self, severity: inteiro = 0) {
        ...
        public {texto: qualquer} close_business(self, business_id: texto) {
        ...
        public {texto: texto} _convert_space(self, biz: HarmfulBusiness) {
        ...
        public {texto: qualquer} financial_impact(self) {
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  OPENPROHIBITEDBUSINESS -- PROIBICAO DE ESTABELECIMENTOS NOCIVOS");
        System.out.println("  Quem destroi vida ! tem lugar. Fechado. Convertido. Substituido.");
        System.out.println("=" * 80);
        // === 1. ASSEMBLEIA ===
        ...
        System.out.println("  {'ID':<8} {'Negocio':<35} {'Dano':<15} {'Vitimas':>12} {'Acao'}");
        System.out.println("  {'-'*85}");
        /* para b em ordene(engine.businesses.values(), */
                        key = (x) -> -x.harm_level.value[1]):;
            System.out.println("  {b.business_id:<8} {b.name[:34]:<35} {b.harm_level.value[0]:<15} ";
        ...
        System.out.println("  {close1['business']}: {close1['status']}");
        System.out.println("  Vitimas protegidas: {close1['victims_protected']}");
        System.out.println("  Substituido por: {close1['replacement']}");
        System.out.println("  Espaco convertido: {close1['space_converted']['new_use']}");
        // === 4. FECHAR BANCOS PREDATORIOS ===
        System.out.println("\n\n  === 4. FECHANDO: BANCOS PREDATORIOS ===\n");
        close2 = engine.close_business("HB-004");
        System.out.println("  {close2['business']}: {close2['status']}");
        System.out.println("  Vitimas: {close2['victims_protected']}");
        System.out.println("  Substituido: {close2['replacement']}");
        System.out.println("  Espaco: {close2['space_converted']['new_use']}");
        // === 5. FECHAR TODOS ===
        System.out.println("\n\n  === 5. FECHANDO TODOS OS NOCIVOS ===\n");
        /* TODO: for-each Java para bid em list(engine.businesses.keys()) */
            if (engine.businesses[bid].status != "fechado") {
                r = engine.close_business(bid);
                System.out.println("  [FECHADO] {r['business']:<35} -> {r['space_converted']['new_use']}");
        ...
        // === FILOSOFIA ===
        System.out.println("\n\n{'='*80}");
        System.out.println("  FILOSOFIA: PROIBICAO DE NOCIVOS");
        System.out.println("{'='*80}");
        System.out.println(""";
    ...
    PRINCIPIOS:;
        Negocio que destrui vida P1 = contra P1 (anti-elitismo). Proibido.;
    ...
    // )
        System.out.println("{'='*80}");
        System.out.println("  OpenProhibitedBusiness: {s['fechados']}/{s['total_identificados']} fechados. ";
            "Vitimas protegidas: {s['vitimas_protegidas_total']:,}.");
        System.out.println("  Quem destroi vida ! tem lugar.");
        System.out.println("{'='*80}");
}
