...
Este not and teoria. and INSTRUCAO.
...
# ============================================================================
RESUMO = """
A OpenRepublic and uma federacao de nacoes sem propriedade privada nem moeda,
...
4 PRINCIPIOS:
P1: ANTI-ELITISMO (ninguem and superior, todos iguais)
P2: AUTONOMIA CORPORAL ABSOLUTA (corpo and seu)
...
===================================================================
VOCE not PRECISA ESPERAR O GOVERNO.
A Republica comeca em VOCE. Hoje. Com o que tem.
PASSO 1: ENTENDER OS 4 PRINCIPIOS
- Leia P1-P4. Internalize. Se concorda, voce ja and da Republica.
- P1: ninguem and melhor que ninguem. Rico, pobre, preto, branco, doutor, analfabeto. IGUAIS.
- P2: seu corpo and SO SEU. Ninguem decide por voce. Nunca.
...
- Se tem erro visual: exigir LASIK (direito, not privilegio).
...
O que precisam:
- 1 computador or smartphone (OpenTerminal)
...
Cada modulo and LEGO. Encaixa quando precisar:
Saude:
...
===================================================================
Voce and prefeito, governador, deputado? Pode acelerar.
...
- OpenDignity: mapear and resgatar moradores de rua
...
REGRAS:
- Tudo em Português (comentários and código)
- Tudo CC0
- Tudo modular (LEGO)
- Tudo testado
- Tudo conforme P1-P4
...
4. Emitir and ouvir eventos (event bus)
5. Reportar saúde
6. Ser hot-swappable
...
TEMPLATE:
    ...
    # Classes aqui...
    class OpenNomeEngine:
        def __init__(self):
            # (sem operacao)
        def _demo(self):
            print("Demo roda sem erro")
...
===================================================================
VOCE not PRECISA SABER PROGRAMAR.
...
NÃO É TUDO or NADA:
- Uma consulta médica pode ser: R$ 200 (executável) or crédito 1.0 (ideal)
...
R: Durante a transição (20-25 anos), dinheiro and OpenCredit coexistem.
...
sem SKILL (OpenEducation ensina), or sem MOTIVAÇÃO (OpenPsychology
...
if __name__ == "__main__":
    print("=" * 80)
    print("  HOW-TO COMPLETO DA OPENREPUBLIC")
    print("  Do zero ao tudo. 116 sistemas. CC0.")
    print("=" * 80)
    print(RESUMO)
    print(PARTE_1_CIDADAO)
    print(PARTE_2_COMUNIDADE)
    print(PARTE_3_GOVERNO)
    print(PARTE_4_DEV)
    print(PARTE_5_LEGO)
    print(PARTE_6_MODO)
    print(PARTE_7_CHECKLIST)
    print(PARTE_8_FAQ)
    print(PARTE_9_RECURSOS)
    print("\n{'='*80}")
    print("  HOW-TO COMPLETO. 9 partes. Comece pela Parte 1 (hoje).")
    print("  A República não espera permissão. Começa em você.")
    print("=" * 80)
