...
public class HowToCompletoDaOpenrepublic {
    ...
    TEMPLATE:;
        ...
        // Classes aqui...
        public static class OpenNomeEngine {
            public void __init__(self) {
                // (sem operacao)
            public void _demo(self) {
                System.out.println("Demo roda sem erro");
    ...
    if (__name__ == "__main__") {
        ...
        System.out.println("  HOW-TO COMPLETO DA OPENREPUBLIC");
        System.out.println("  Do zero ao tudo. 116 sistemas. CC0.");
        System.out.println("=" * 80);
        System.out.println(RESUMO);
        System.out.println(PARTE_1_CIDADAO);
        System.out.println(PARTE_2_COMUNIDADE);
        System.out.println(PARTE_3_GOVERNO);
        System.out.println(PARTE_4_DEV);
        System.out.println(PARTE_5_LEGO);
        System.out.println(PARTE_6_MODO);
        System.out.println(PARTE_7_CHECKLIST);
        System.out.println(PARTE_8_FAQ);
        System.out.println(PARTE_9_RECURSOS);
        System.out.println("\n{'='*80}");
        System.out.println("  HOW-TO COMPLETO. 9 partes. Comece pela Parte 1 (hoje).");
        System.out.println("  A República não espera permissão. Começa em você.");
        System.out.println("=" * 80);
}
