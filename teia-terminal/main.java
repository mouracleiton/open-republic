...
public class TeiaTerminalStackDefinitivaEsqueleto {
    ...
    public static class User {
        ...
        boolean is_teia_direct = false;
        boolean is_active = true;
        boolean vpn_key_active = true;
        boolean monthly_paid = true;
    ...
    public {texto: qualquer} check_module_access(user: User, module_id: texto) {
    ...
    public void view_module(request: Request, module_id: texto) {
    ...
    public void simulador(request: Request, modelo: texto) {
    ...
    public void api_simular(modelo: texto, valor: flutuante) {
    ...
    public void gerar_dossie(request: Request) {
    ...
    public void validacao_gate_a(request: Request) {
    ...
    public void switch_user(user_id: texto) {
    ...
    if (__name__ == "__main__") {
        // importa uvicorn
        System.out.println("TEIA Terminal v{TEIA_VERSION}");
        System.out.println("Ambiente: {TEIA_ENV}");
        System.out.println("URL: http://localhost:8000");
        System.out.println("Usuários demo: cleiton, demo_base, demo_analista, demo_espec");
        System.out.println("Trocar usuário: /switch-user/<id>");
        System.out.println();
